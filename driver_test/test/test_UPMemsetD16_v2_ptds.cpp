/*
 * Auto-generated smoke test for driver wrapper UPMemsetD16_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD16_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD16_v2_ptds(dptr, (unsigned short)0, (size_t)0);

    printf("UPMemsetD16_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD16_v2_ptds PASS\n");
    return 0;
}
