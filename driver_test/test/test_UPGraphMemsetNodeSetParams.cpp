/*
 * Auto-generated smoke test for driver wrapper UPGraphMemsetNodeSetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_MEMSET_NODE_PARAMS local_nodeParams{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphMemsetNodeSetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphMemsetNodeSetParams(graphNode, &local_nodeParams);

    printf("UPGraphMemsetNodeSetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphMemsetNodeSetParams PASS\n");
    return 0;
}
