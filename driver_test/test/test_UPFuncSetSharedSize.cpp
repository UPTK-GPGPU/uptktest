/*
 * Auto-generated smoke test for driver wrapper UPFuncSetSharedSize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFuncSetSharedSize setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPFuncSetSharedSize PASS\n");
    return 0;
}
