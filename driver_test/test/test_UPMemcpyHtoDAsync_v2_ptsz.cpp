/*
 * Auto-generated smoke test for driver wrapper UPMemcpyHtoDAsync_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyHtoDAsync_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyHtoDAsync_v2_ptsz(dptr, (const void*)nullptr, (size_t)0, stream);

    printf("UPMemcpyHtoDAsync_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyHtoDAsync_v2_ptsz PASS\n");
    return 0;
}
