/*
 * Auto-generated smoke test for driver wrapper UPLaunchCooperativeKernel (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchCooperativeKernel setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLaunchCooperativeKernel(kern, 0u, 0u, 0u, 0u, 0u, 0u, 0u, stream, (void**)nullptr);

    printf("UPLaunchCooperativeKernel -> %d\n", (int)err);
    ...
    printf("test_UPLaunchCooperativeKernel PASS\n");
    return 0;
}
