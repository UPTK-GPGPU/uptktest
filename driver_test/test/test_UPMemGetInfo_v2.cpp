/*
 * Auto-generated smoke test for driver wrapper UPMemGetInfo_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemGetInfo_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemGetInfo_v2(&local_free, &local_total);

    printf("UPMemGetInfo_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemGetInfo_v2 PASS\n");
    return 0;
}
