/*
 * Auto-generated smoke test for driver wrapper UPLaunchKernel_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchKernel_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPLaunchKernel_ptsz PASS\n");
    return 0;
}
