/*
 * Auto-generated smoke test for driver wrapper UPMemPrefetchAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPrefetchAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPrefetchAsync(dptr, (size_t)0, dev, stream);

    printf("UPMemPrefetchAsync -> %d\n", (int)err);
    ...
    printf("test_UPMemPrefetchAsync PASS\n");
    return 0;
}
