/*
 * Auto-generated smoke test for driver wrapper UPModuleLoad (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleLoad setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleLoad(&local_module, &local_fname);

    printf("UPModuleLoad -> %d\n", (int)err);
