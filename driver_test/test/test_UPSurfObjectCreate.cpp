/*
 * Auto-generated smoke test for driver wrapper UPSurfObjectCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKSurfaceObject_t local_pSurfObject{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPSurfObjectCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPSurfObjectCreate(&local_pSurfObject, &local_pResDesc);

    printf("UPSurfObjectCreate -> %d\n", (int)err);
    ...
    printf("test_UPSurfObjectCreate PASS\n");
    return 0;
}
