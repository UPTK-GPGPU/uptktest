/*
 * Auto-generated smoke test for driver wrapper UPCtxGetDevice (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetDevice setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetDevice(&local_device);

    printf("UPCtxGetDevice -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetDevice PASS\n");
    return 0;
}
