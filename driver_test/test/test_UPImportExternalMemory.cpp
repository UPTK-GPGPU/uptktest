/*
 * Auto-generated smoke test for driver wrapper UPImportExternalMemory (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_EXTERNAL_MEMORY_HANDLE_DESC local_memHandleDesc{};
    UPTKExternalMemory_t local_extMem_out{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPImportExternalMemory setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPImportExternalMemory PASS\n");
    return 0;
}
