/*
 * Auto-generated smoke test for driver wrapper UPMemPoolTrimTo (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolTrimTo setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolTrimTo(memPool, (size_t)0);

    printf("UPMemPoolTrimTo -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolTrimTo PASS\n");
    return 0;
}
