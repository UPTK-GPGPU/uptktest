/*
 * Auto-generated smoke test for driver wrapper UPGraphExecBatchMemOpNodeSetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphExecBatchMemOpNodeSetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphExecBatchMemOpNodeSetParams(graphExec, graphNode, &local_nodeParams);

    printf("UPGraphExecBatchMemOpNodeSetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphExecBatchMemOpNodeSetParams PASS\n");
    return 0;
}
