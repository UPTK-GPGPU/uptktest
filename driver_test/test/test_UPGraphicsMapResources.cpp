/*
 * Auto-generated smoke test for driver wrapper UPGraphicsMapResources (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsMapResources setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsMapResources(0u, &local_resources, stream);

    printf("UPGraphicsMapResources -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsMapResources PASS\n");
    return 0;
}
