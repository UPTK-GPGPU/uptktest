/*
 * Auto-generated smoke test for driver wrapper UPMemHostGetDevicePointer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemHostGetDevicePointer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemHostGetDevicePointer(&local_pdptr, (void*)nullptr, 0u);

    printf("UPMemHostGetDevicePointer -> %d\n", (int)err);
    ...
    printf("test_UPMemHostGetDevicePointer PASS\n");
    return 0;
}
