/*
 * Auto-generated smoke test for driver wrapper UPMemAddressReserve (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAddressReserve setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAddressReserve(&local_ptr, (size_t)0, (size_t)0, dptr, 0ull);

    printf("UPMemAddressReserve -> %d\n", (int)err);
    ...
    printf("test_UPMemAddressReserve PASS\n");
    return 0;
}
