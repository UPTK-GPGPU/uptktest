/*
 * Auto-generated smoke test for driver wrapper UPPointerGetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPPointerGetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPPointerGetAttribute((void*)nullptr, (UPTKpointer_attribute)0, dptr);

    printf("UPPointerGetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPPointerGetAttribute PASS\n");
    return 0;
}
