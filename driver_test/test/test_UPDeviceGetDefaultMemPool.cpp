/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetDefaultMemPool (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetDefaultMemPool setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetDefaultMemPool(&local_pool_out, dev);

    printf("UPDeviceGetDefaultMemPool -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetDefaultMemPool PASS\n");
    return 0;
}
