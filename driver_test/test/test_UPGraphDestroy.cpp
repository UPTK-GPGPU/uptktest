/*
 * Auto-generated smoke test for driver wrapper UPGraphDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphDestroy(graph);

    printf("UPGraphDestroy -> %d\n", (int)err);
    ...
    printf("test_UPGraphDestroy PASS\n");
    return 0;
}
