/*
 * Auto-generated smoke test for driver wrapper UPIpcOpenMemHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPIpcOpenMemHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPIpcOpenMemHandle(&local_pdptr, (UPTKIpcMemHandle_t){}, 0u);

    printf("UPIpcOpenMemHandle -> %d\n", (int)err);
    ...
    printf("test_UPIpcOpenMemHandle PASS\n");
    return 0;
}
