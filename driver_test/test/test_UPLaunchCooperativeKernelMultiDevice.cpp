/*
 * Auto-generated smoke test for driver wrapper UPLaunchCooperativeKernelMultiDevice (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_LAUNCH_PARAMS local_launchParamsList{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchCooperativeKernelMultiDevice setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLaunchCooperativeKernelMultiDevice(&local_launchParamsList, 0u, 0u);

    printf("UPLaunchCooperativeKernelMultiDevice -> %d\n", (int)err);
    ...
    printf("test_UPLaunchCooperativeKernelMultiDevice PASS\n");
    return 0;
}
