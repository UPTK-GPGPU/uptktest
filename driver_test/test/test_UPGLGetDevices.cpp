/*
 * Auto-generated smoke test for driver wrapper UPGLGetDevices (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    unsigned int local_pCudaDeviceCount{};
    UPTKdevice local_pCudaDevices{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGLGetDevices setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGLGetDevices(&local_pCudaDeviceCount, &local_pCudaDevices, 0u, (UPTKGLDeviceList)0);

    printf("UPGLGetDevices -> %d\n", (int)err);
    ...
    printf("test_UPGLGetDevices PASS\n");
    return 0;
}
