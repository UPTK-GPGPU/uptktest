/*
 * Auto-generated smoke test for driver wrapper UPMemHostAlloc (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemHostAlloc setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemHostAlloc((void**)nullptr, (size_t)0, 0u);

    printf("UPMemHostAlloc -> %d\n", (int)err);
    ...
    printf("test_UPMemHostAlloc PASS\n");
    return 0;
}
