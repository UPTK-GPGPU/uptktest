/*
 * Auto-generated smoke test for driver wrapper UPMemMap (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemMap setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemMap(dptr, (size_t)0, (size_t)0, (UPTKmemGenericAllocationHandle)0, 0ull);
