/*
 * Auto-generated smoke test for driver wrapper UPMemcpyHtoAAsync_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyHtoAAsync_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyHtoAAsync_v2(arr, (size_t)0, (const void*)nullptr, (size_t)0, stream);

    printf("UPMemcpyHtoAAsync_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyHtoAAsync_v2 PASS\n");
    return 0;
}
