/*
 * Auto-generated smoke test for driver wrapper UPMemAllocHost (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAllocHost setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAllocHost((void**)nullptr, (size_t)0);

    printf("UPMemAllocHost -> %d\n", (int)err);
    ...
    printf("test_UPMemAllocHost PASS\n");
    return 0;
}
