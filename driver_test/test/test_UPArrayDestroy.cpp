/*
 * Auto-generated smoke test for driver wrapper UPArrayDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPArrayDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPArrayDestroy(arr);

    printf("UPArrayDestroy -> %d\n", (int)err);
    ...
    printf("test_UPArrayDestroy PASS\n");
    return 0;
}
