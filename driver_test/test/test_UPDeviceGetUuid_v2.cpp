/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetUuid_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetUuid_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetUuid_v2(&local_uuid, dev);

    printf("UPDeviceGetUuid_v2 -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetUuid_v2 PASS\n");
    return 0;
}
