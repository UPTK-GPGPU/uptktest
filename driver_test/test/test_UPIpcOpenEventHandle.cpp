/*
 * Auto-generated smoke test for driver wrapper UPIpcOpenEventHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPIpcOpenEventHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPIpcOpenEventHandle(&local_phEvent, (UPTKIpcEventHandle_t){});

    printf("UPIpcOpenEventHandle -> %d\n", (int)err);
    ...
    printf("test_UPIpcOpenEventHandle PASS\n");
    return 0;
}
