/*
 * Auto-generated smoke test for driver wrapper UPMemcpyAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyAsync(dptr, dptr, (size_t)0, stream);

    printf("UPMemcpyAsync -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyAsync PASS\n");
    return 0;
}
