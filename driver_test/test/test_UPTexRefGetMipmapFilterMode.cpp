/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetMipmapFilterMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetMipmapFilterMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetMipmapFilterMode(&local_pfm, texRef);

    printf("UPTexRefGetMipmapFilterMode -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetMipmapFilterMode PASS\n");
    return 0;
}
