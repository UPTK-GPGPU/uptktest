/*
 * Auto-generated smoke test for driver wrapper UPMemPoolDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolDestroy(memPool);

    printf("UPMemPoolDestroy -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolDestroy PASS\n");
    return 0;
}
