/*
 * Auto-generated smoke test for driver wrapper UPMemGetHandleForAddressRange (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemGetHandleForAddressRange setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemGetHandleForAddressRange((void*)nullptr, dptr, (size_t)0, (UPTKmemRangeHandleType)0, 0ull);

    printf("UPMemGetHandleForAddressRange -> %d\n", (int)err);
    ...
    printf("test_UPMemGetHandleForAddressRange PASS\n");
    return 0;
}
