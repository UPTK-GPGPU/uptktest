/*
 * Auto-generated smoke test for driver wrapper UPTexObjectCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_RESOURCE_DESC local_pResDesc{};
    UPTK_RESOURCE_VIEW_DESC local_pResViewDesc{};
    UPTK_TEXTURE_DESC local_pTexDesc{};
    UPTKTextureObject_t local_pTexObject{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexObjectCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexObjectCreate(&local_pTexObject, &local_pResDesc, &local_pTexDesc, &local_pResViewDesc);

    printf("UPTexObjectCreate -> %d\n", (int)err);
    ...
    printf("test_UPTexObjectCreate PASS\n");
    return 0;
}
