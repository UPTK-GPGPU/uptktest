/*
 * Auto-generated smoke test for driver wrapper UPMemPoolCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKMemPool_t local_pool{};
    UPTKMemPoolProps local_poolProps{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolCreate(&local_pool, &local_poolProps);

    printf("UPMemPoolCreate -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolCreate PASS\n");
    return 0;
}
