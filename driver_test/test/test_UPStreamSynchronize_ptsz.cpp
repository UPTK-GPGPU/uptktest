/*
 * Auto-generated smoke test for driver wrapper UPStreamSynchronize_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamSynchronize_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamSynchronize_ptsz(stream);

    printf("UPStreamSynchronize_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamSynchronize_ptsz PASS\n");
    return 0;
}
