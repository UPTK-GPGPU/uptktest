/*
 * Auto-generated smoke test for driver wrapper UPGraphChildGraphNodeGetGraph (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphChildGraphNodeGetGraph setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphChildGraphNodeGetGraph(graphNode, &local_phGraph);

    printf("UPGraphChildGraphNodeGetGraph -> %d\n", (int)err);
    ...
    printf("test_UPGraphChildGraphNodeGetGraph PASS\n");
    return 0;
}
