/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetName (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetName setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetName(&local_name, 0, dev);

    printf("UPDeviceGetName -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetName PASS\n");
    return 0;
}
