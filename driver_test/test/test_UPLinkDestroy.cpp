/*
 * Auto-generated smoke test for driver wrapper UPLinkDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLinkDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLinkDestroy(linkState);

    printf("UPLinkDestroy -> %d\n", (int)err);
    ...
    printf("test_UPLinkDestroy PASS\n");
    return 0;
}
