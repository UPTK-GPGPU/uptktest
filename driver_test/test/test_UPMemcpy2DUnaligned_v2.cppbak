/*
 * Auto-generated smoke test for driver wrapper UPMemcpy2DUnaligned_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy2DUnaligned_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy2DUnaligned_v2(&local_pCopy);

    printf("UPMemcpy2DUnaligned_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy2DUnaligned_v2 PASS\n");
    return 0;
}
