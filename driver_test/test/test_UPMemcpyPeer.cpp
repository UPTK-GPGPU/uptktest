/*
 * Auto-generated smoke test for driver wrapper UPMemcpyPeer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyPeer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyPeer(dptr, ctx, dptr, ctx, (size_t)0);

    printf("UPMemcpyPeer -> %d\n", (int)err);
