/*
 * Auto-generated smoke test for driver wrapper UPStreamGetCaptureInfo_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    cuuint64_t local_id_out{};
    size_t local_numDependencies_out{};
    UPTKGraph_t local_graph_out{};
    const UPTKGraphNode_t * local_dependencies_out{};
    UPTKStreamCaptureStatus local_captureStatus_out{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetCaptureInfo_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetCaptureInfo_v2_ptsz(stream, &local_captureStatus_out, &local_id_out, &local_graph_out, &local_dependencies_out, &local_numDependencies_out);

    printf("UPStreamGetCaptureInfo_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetCaptureInfo_v2_ptsz PASS\n");
    return 0;
}
