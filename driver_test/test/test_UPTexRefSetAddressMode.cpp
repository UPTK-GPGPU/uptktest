/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetAddressMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetAddressMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetAddressMode(texRef, 0, (UPTKaddress_mode)0);

    printf("UPTexRefSetAddressMode -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetAddressMode PASS\n");
    return 0;
}
