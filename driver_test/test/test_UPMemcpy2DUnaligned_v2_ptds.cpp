/*
 * Auto-generated smoke test for driver wrapper UPMemcpy2DUnaligned_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy2DUnaligned_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy2DUnaligned_v2_ptds(&local_pCopy);

    printf("UPMemcpy2DUnaligned_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy2DUnaligned_v2_ptds PASS\n");
    return 0;
}
