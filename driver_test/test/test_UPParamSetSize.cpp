/*
 * Auto-generated smoke test for driver wrapper UPParamSetSize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPParamSetSize setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPParamSetSize(kern, 0u);

    printf("UPParamSetSize -> %d\n", (int)err);
    ...
    printf("test_UPParamSetSize PASS\n");
    return 0;
}
