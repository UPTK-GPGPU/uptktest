/*
 * Auto-generated smoke test for driver wrapper UPGraphExecDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphExecDestroy setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPGraphExecDestroy PASS\n");
    return 0;
}
