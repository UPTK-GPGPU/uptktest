/*
 * Auto-generated smoke test for driver wrapper UPDeviceComputeCapability (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceComputeCapability setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceComputeCapability(&local_major, &local_minor, dev);

    printf("UPDeviceComputeCapability -> %d\n", (int)err);
    ...
    printf("test_UPDeviceComputeCapability PASS\n");
    return 0;
}
