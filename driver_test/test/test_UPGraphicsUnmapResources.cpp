/*
 * Auto-generated smoke test for driver wrapper UPGraphicsUnmapResources (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsUnmapResources setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsUnmapResources(0u, &local_resources, stream);

    printf("UPGraphicsUnmapResources -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsUnmapResources PASS\n");
    return 0;
}
