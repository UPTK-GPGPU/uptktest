/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetUuid (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetUuid setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetUuid(&local_uuid, dev);

    printf("UPDeviceGetUuid -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetUuid PASS\n");
    return 0;
}
