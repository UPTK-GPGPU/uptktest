/*
 * Auto-generated smoke test for driver wrapper UPMemPoolImportFromShareableHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolImportFromShareableHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolImportFromShareableHandle(&local_pool_out, (void*)nullptr, (UPTKMemAllocationHandleType)0, 0ull);

    printf("UPMemPoolImportFromShareableHandle -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolImportFromShareableHandle PASS\n");
    return 0;
}
