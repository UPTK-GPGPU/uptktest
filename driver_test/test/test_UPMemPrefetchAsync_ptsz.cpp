/*
 * Auto-generated smoke test for driver wrapper UPMemPrefetchAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPrefetchAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPrefetchAsync_ptsz(dptr, (size_t)0, dev, stream);

    printf("UPMemPrefetchAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemPrefetchAsync_ptsz PASS\n");
    return 0;
}
