/*
 * Auto-generated smoke test for driver wrapper UPModuleLoadDataEx (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKjit_option local_options{};
    UPTKmodule local_module{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleLoadDataEx setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleLoadDataEx(&local_module, (const void*)nullptr, 0u, &local_options, (void**)nullptr);

    printf("UPModuleLoadDataEx -> %d\n", (int)err);
    ...
    printf("test_UPModuleLoadDataEx PASS\n");
    return 0;
}
