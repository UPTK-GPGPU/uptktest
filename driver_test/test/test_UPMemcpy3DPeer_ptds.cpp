/*
 * Auto-generated smoke test for driver wrapper UPMemcpy3DPeer_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy3DPeer_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy3DPeer_ptds(&local_pCopy);

    printf("UPMemcpy3DPeer_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy3DPeer_ptds PASS\n");
    return 0;
}
