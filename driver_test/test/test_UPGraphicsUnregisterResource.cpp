/*
 * Auto-generated smoke test for driver wrapper UPGraphicsUnregisterResource (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsUnregisterResource setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsUnregisterResource(gfxRes);

    printf("UPGraphicsUnregisterResource -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsUnregisterResource PASS\n");
    return 0;
}
