/*
 * Auto-generated smoke test for driver wrapper UPMipmappedArrayGetLevel (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMipmappedArrayGetLevel setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMipmappedArrayGetLevel(&local_pLevelArray, mipmap, 0u);

    printf("UPMipmappedArrayGetLevel -> %d\n", (int)err);
    ...
    printf("test_UPMipmappedArrayGetLevel PASS\n");
    return 0;
}
