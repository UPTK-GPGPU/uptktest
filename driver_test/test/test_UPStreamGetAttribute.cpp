/*
 * Auto-generated smoke test for driver wrapper UPStreamGetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetAttribute(stream, (UPTKStreamAttrID)0, &local_value_out);

    printf("UPStreamGetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetAttribute PASS\n");
    return 0;
}
