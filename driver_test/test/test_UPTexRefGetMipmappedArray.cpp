/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetMipmappedArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKMipmappedArray_t local_phMipmappedArray{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetMipmappedArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetMipmappedArray(&local_phMipmappedArray, texRef);

    printf("UPTexRefGetMipmappedArray -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetMipmappedArray PASS\n");
    return 0;
}
