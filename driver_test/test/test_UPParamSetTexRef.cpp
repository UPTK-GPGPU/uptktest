/*
 * Auto-generated smoke test for driver wrapper UPParamSetTexRef (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPParamSetTexRef setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPParamSetTexRef(kern, 0, texRef);

    printf("UPParamSetTexRef -> %d\n", (int)err);
    ...
    printf("test_UPParamSetTexRef PASS\n");
    return 0;
}
