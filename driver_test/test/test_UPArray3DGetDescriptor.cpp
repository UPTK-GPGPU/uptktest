/*
 * Auto-generated smoke test for driver wrapper UPArray3DGetDescriptor (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_ARRAY3D_DESCRIPTOR local_pArrayDescriptor{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPArray3DGetDescriptor setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPArray3DGetDescriptor(&local_pArrayDescriptor, arr);

    printf("UPArray3DGetDescriptor -> %d\n", (int)err);
    ...
    printf("test_UPArray3DGetDescriptor PASS\n");
    return 0;
}
