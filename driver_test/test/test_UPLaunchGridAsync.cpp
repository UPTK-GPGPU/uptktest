/*
 * Auto-generated smoke test for driver wrapper UPLaunchGridAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchGridAsync setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPLaunchGridAsync PASS\n");
    return 0;
}
