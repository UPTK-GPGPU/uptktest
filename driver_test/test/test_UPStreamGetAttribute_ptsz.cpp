/*
 * Auto-generated smoke test for driver wrapper UPStreamGetAttribute_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKStreamAttrValue local_value_out{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetAttribute_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetAttribute_ptsz(stream, (UPTKStreamAttrID)0, &local_value_out);

    printf("UPStreamGetAttribute_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetAttribute_ptsz PASS\n");
    return 0;
}
