/*
 * Auto-generated smoke test for driver wrapper UPEventRecordWithFlags_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventRecordWithFlags_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventRecordWithFlags_ptsz(evt, stream, 0u);

    printf("UPEventRecordWithFlags_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPEventRecordWithFlags_ptsz PASS\n");
    return 0;
}
