/*
 * Auto-generated smoke test for driver wrapper UPMemcpyPeerAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyPeerAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyPeerAsync(dptr, ctx, dptr, ctx, (size_t)0, stream);

    printf("UPMemcpyPeerAsync -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyPeerAsync PASS\n");
    return 0;
}
