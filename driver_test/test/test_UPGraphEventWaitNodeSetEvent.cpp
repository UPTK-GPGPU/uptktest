/*
 * Auto-generated smoke test for driver wrapper UPGraphEventWaitNodeSetEvent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphEventWaitNodeSetEvent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphEventWaitNodeSetEvent(graphNode, evt);

    printf("UPGraphEventWaitNodeSetEvent -> %d\n", (int)err);
    ...
    printf("test_UPGraphEventWaitNodeSetEvent PASS\n");
    return 0;
}
