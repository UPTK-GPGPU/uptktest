/*
 * Auto-generated smoke test for driver wrapper UPEventSynchronize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventSynchronize setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventSynchronize(evt);

    printf("UPEventSynchronize -> %d\n", (int)err);
    ...
    printf("test_UPEventSynchronize PASS\n");
    return 0;
}
