/*
 * Auto-generated smoke test for driver wrapper UPGetExportTable (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGetExportTable setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGetExportTable((const void**)nullptr, &local_pExportTableId);

    printf("UPGetExportTable -> %d\n", (int)err);
    ...
    printf("test_UPGetExportTable PASS\n");
    return 0;
}
