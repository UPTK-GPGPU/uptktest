/*
 * Auto-generated smoke test for driver wrapper UPMemsetD8Async_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD8Async_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD8Async_ptsz(dptr, (unsigned char)0, (size_t)0, stream);

    printf("UPMemsetD8Async_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD8Async_ptsz PASS\n");
    return 0;
}
