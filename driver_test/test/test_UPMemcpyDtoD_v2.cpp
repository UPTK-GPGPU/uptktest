/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoD_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoD_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoD_v2(dptr, dptr, (size_t)0);

    printf("UPMemcpyDtoD_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoD_v2 PASS\n");
    return 0;
}
