/*
 * Auto-generated smoke test for driver wrapper UPModuleGetGlobal_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleGetGlobal_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleGetGlobal_v2(&local_dptr, &local_bytes, mod, &local_name);

    printf("UPModuleGetGlobal_v2 -> %d\n", (int)err);
    ...
    printf("test_UPModuleGetGlobal_v2 PASS\n");
    return 0;
}
