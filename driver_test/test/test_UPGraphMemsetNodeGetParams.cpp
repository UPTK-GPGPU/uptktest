/*
 * Auto-generated smoke test for driver wrapper UPGraphMemsetNodeGetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphMemsetNodeGetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphMemsetNodeGetParams(graphNode, &local_nodeParams);

    printf("UPGraphMemsetNodeGetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphMemsetNodeGetParams PASS\n");
    return 0;
}
