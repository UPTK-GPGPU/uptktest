/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoH_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoH_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoH_v2_ptds((void*)nullptr, dptr, (size_t)0);

    printf("UPMemcpyDtoH_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoH_v2_ptds PASS\n");
    return 0;
}
