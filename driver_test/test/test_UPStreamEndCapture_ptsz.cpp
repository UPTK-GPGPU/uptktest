/*
 * Auto-generated smoke test for driver wrapper UPStreamEndCapture_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamEndCapture_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamEndCapture_ptsz(stream, &local_phGraph);

    printf("UPStreamEndCapture_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamEndCapture_ptsz PASS\n");
    return 0;
}
