/*
 * Auto-generated smoke test for driver wrapper UPGraphEventRecordNodeGetEvent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphEventRecordNodeGetEvent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphEventRecordNodeGetEvent(graphNode, &local_event_out);

    printf("UPGraphEventRecordNodeGetEvent -> %d\n", (int)err);
    ...
    printf("test_UPGraphEventRecordNodeGetEvent PASS\n");
    return 0;
}
