/*
 * Auto-generated smoke test for driver wrapper UPOccupancyMaxPotentialBlockSize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPOccupancyMaxPotentialBlockSize setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPOccupancyMaxPotentialBlockSize(&local_minGridSize, &local_blockSize, kern, (UPTKoccupancyB2DSize)nullptr, (size_t)0, 0);

    printf("UPOccupancyMaxPotentialBlockSize -> %d\n", (int)err);
    ...
    printf("test_UPOccupancyMaxPotentialBlockSize PASS\n");
    return 0;
}
