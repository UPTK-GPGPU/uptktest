/*
 * Auto-generated smoke test for driver wrapper UPGraphNodeSetEnabled (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphNodeSetEnabled setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphNodeSetEnabled(graphExec, graphNode, 0u);

    printf("UPGraphNodeSetEnabled -> %d\n", (int)err);
    ...
    printf("test_UPGraphNodeSetEnabled PASS\n");
    return 0;
}
