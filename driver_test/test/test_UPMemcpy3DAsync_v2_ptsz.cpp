/*
 * Auto-generated smoke test for driver wrapper UPMemcpy3DAsync_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy3DAsync_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy3DAsync_v2_ptsz(&local_pCopy, stream);

    printf("UPMemcpy3DAsync_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy3DAsync_v2_ptsz PASS\n");
    return 0;
}
