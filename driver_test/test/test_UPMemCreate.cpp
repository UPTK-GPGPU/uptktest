/*
 * Auto-generated smoke test for driver wrapper UPMemCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemCreate(&local_handle, (size_t)0, &local_prop, 0ull);

    printf("UPMemCreate -> %d\n", (int)err);
