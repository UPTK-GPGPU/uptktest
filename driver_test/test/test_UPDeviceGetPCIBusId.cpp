/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetPCIBusId (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetPCIBusId setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetPCIBusId(&local_pciBusId, 0, dev);

    printf("UPDeviceGetPCIBusId -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetPCIBusId PASS\n");
    return 0;
}
