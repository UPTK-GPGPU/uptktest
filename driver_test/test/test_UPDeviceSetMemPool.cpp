/*
 * Auto-generated smoke test for driver wrapper UPDeviceSetMemPool (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceSetMemPool setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceSetMemPool(dev, memPool);

    printf("UPDeviceSetMemPool -> %d\n", (int)err);
    ...
    printf("test_UPDeviceSetMemPool PASS\n");
    return 0;
}
