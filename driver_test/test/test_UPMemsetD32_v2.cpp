/*
 * Auto-generated smoke test for driver wrapper UPMemsetD32_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD32_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD32_v2(dptr, 0u, (size_t)0);

    printf("UPMemsetD32_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD32_v2 PASS\n");
    return 0;
}
