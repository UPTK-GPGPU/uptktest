/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetCount (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetCount setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetCount(&local_count);

    printf("UPDeviceGetCount -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetCount PASS\n");
    return 0;
}
