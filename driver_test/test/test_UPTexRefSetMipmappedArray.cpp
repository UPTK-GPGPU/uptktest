/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetMipmappedArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetMipmappedArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetMipmappedArray(texRef, mipmap, 0u);

    printf("UPTexRefSetMipmappedArray -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetMipmappedArray PASS\n");
    return 0;
}
