/*
 * Auto-generated smoke test for driver wrapper UPPointerGetAttributes (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKpointer_attribute local_attributes{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPPointerGetAttributes setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPPointerGetAttributes(0u, &local_attributes, (void**)nullptr, dptr);

    printf("UPPointerGetAttributes -> %d\n", (int)err);
    ...
    printf("test_UPPointerGetAttributes PASS\n");
    return 0;
}
