/*
 * Auto-generated smoke test for driver wrapper UPGraphHostNodeSetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphHostNodeSetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphHostNodeSetParams(graphNode, &local_nodeParams);

    printf("UPGraphHostNodeSetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphHostNodeSetParams PASS\n");
    return 0;
}
