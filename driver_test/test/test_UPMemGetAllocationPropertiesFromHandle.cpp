/*
 * Auto-generated smoke test for driver wrapper UPMemGetAllocationPropertiesFromHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemGetAllocationPropertiesFromHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemGetAllocationPropertiesFromHandle(&local_prop, (UPTKmemGenericAllocationHandle)0);

    printf("UPMemGetAllocationPropertiesFromHandle -> %d\n", (int)err);
    ...
    printf("test_UPMemGetAllocationPropertiesFromHandle PASS\n");
    return 0;
}
