/*
 * Auto-generated smoke test for driver wrapper UPMemImportFromShareableHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKmemGenericAllocationHandle local_handle{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemImportFromShareableHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemImportFromShareableHandle(&local_handle, (void*)nullptr, (UPTKMemAllocationHandleType)0);

    printf("UPMemImportFromShareableHandle -> %d\n", (int)err);
    ...
    printf("test_UPMemImportFromShareableHandle PASS\n");
    return 0;
}
