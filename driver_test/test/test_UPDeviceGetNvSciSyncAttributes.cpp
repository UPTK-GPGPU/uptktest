/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetNvSciSyncAttributes (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetNvSciSyncAttributes setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetNvSciSyncAttributes((void*)nullptr, dev, 0);

    printf("UPDeviceGetNvSciSyncAttributes -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetNvSciSyncAttributes PASS\n");
    return 0;
}
