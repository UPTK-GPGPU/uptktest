/*
 * Auto-generated smoke test for driver wrapper UPStreamGetCtx (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetCtx setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetCtx(stream, &local_pctx);

    printf("UPStreamGetCtx -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetCtx PASS\n");
    return 0;
}
