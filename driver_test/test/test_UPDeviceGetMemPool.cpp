/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetMemPool (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetMemPool setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetMemPool(&local_pool, dev);

    printf("UPDeviceGetMemPool -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetMemPool PASS\n");
    return 0;
}
