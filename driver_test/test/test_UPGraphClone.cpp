/*
 * Auto-generated smoke test for driver wrapper UPGraphClone (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKGraph_t local_phGraphClone{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphClone setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphClone(&local_phGraphClone, graph);

    printf("UPGraphClone -> %d\n", (int)err);
