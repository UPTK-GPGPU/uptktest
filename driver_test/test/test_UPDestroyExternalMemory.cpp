/*
 * Auto-generated smoke test for driver wrapper UPDestroyExternalMemory (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDestroyExternalMemory setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDestroyExternalMemory(extMem);

    printf("UPDestroyExternalMemory -> %d\n", (int)err);
    ...
    printf("test_UPDestroyExternalMemory PASS\n");
    return 0;
}
