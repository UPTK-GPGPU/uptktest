/*
 * Auto-generated smoke test for driver wrapper UPCtxCreate_v3 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKexecAffinityParam local_paramsArray{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxCreate_v3 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxCreate_v3(&local_pctx, &local_paramsArray, 0, 0u, dev);

    printf("UPCtxCreate_v3 -> %d\n", (int)err);
    ...
    printf("test_UPCtxCreate_v3 PASS\n");
    return 0;
}
