/*
 * Auto-generated smoke test for driver wrapper UPStreamGetPriority (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetPriority setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetPriority(stream, &local_priority);

    printf("UPStreamGetPriority -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetPriority PASS\n");
    return 0;
}
