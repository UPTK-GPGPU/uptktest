/*
 * Auto-generated smoke test for driver wrapper UPGraphNodeGetEnabled (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphNodeGetEnabled setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphNodeGetEnabled(graphExec, graphNode, &local_isEnabled);

    printf("UPGraphNodeGetEnabled -> %d\n", (int)err);
    ...
    printf("test_UPGraphNodeGetEnabled PASS\n");
    return 0;
}
