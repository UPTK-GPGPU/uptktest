/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetFlags(&local_pFlags, texRef);

    printf("UPTexRefGetFlags -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetFlags PASS\n");
    return 0;
}
