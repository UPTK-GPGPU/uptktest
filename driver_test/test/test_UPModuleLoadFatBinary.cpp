/*
 * Auto-generated smoke test for driver wrapper UPModuleLoadFatBinary (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleLoadFatBinary setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleLoadFatBinary(&local_module, (const void*)nullptr);

    printf("UPModuleLoadFatBinary -> %d\n", (int)err);
    ...
    printf("test_UPModuleLoadFatBinary PASS\n");
    return 0;
}
