/*
 * Auto-generated smoke test for driver wrapper UPSurfRefGetArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPSurfRefGetArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPSurfRefGetArray(&local_phArray, surfRef);

    printf("UPSurfRefGetArray -> %d\n", (int)err);
    ...
    printf("test_UPSurfRefGetArray PASS\n");
    return 0;
}
