/*
 * Auto-generated smoke test for driver wrapper UPMemcpy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy(dptr, dptr, (size_t)0);
