/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetFormat (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    int local_pNumChannels{};
    UPTKarray_format local_pFormat{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetFormat setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetFormat(&local_pFormat, &local_pNumChannels, texRef);

    printf("UPTexRefGetFormat -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetFormat PASS\n");
    return 0;
}
