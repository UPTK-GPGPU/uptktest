/*
 * Auto-generated smoke test for driver wrapper UPMemsetD2D32_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD2D32_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD2D32_v2_ptds(dptr, (size_t)0, 0u, (size_t)0, (size_t)0);

    printf("UPMemsetD2D32_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD2D32_v2_ptds PASS\n");
    return 0;
}
