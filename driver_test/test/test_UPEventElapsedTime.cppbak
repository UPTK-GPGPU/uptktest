/*
 * Auto-generated smoke test for driver wrapper UPEventElapsedTime (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventElapsedTime setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventElapsedTime(&local_pMilliseconds, evt, evt);

    printf("UPEventElapsedTime -> %d\n", (int)err);
    ...
    printf("test_UPEventElapsedTime PASS\n");
    return 0;
}
