/*
 * Auto-generated smoke test for driver wrapper UPMemcpy3DAsync_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy3DAsync_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy3DAsync_v2(&local_pCopy, stream);

    printf("UPMemcpy3DAsync_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy3DAsync_v2 PASS\n");
    return 0;
}
