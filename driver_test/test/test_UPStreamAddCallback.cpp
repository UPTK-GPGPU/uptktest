/*
 * Auto-generated smoke test for driver wrapper UPStreamAddCallback (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamAddCallback setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamAddCallback(stream, (UPTKstreamCallback)nullptr, (void*)nullptr, 0u);

    printf("UPStreamAddCallback -> %d\n", (int)err);
    ...
    printf("test_UPStreamAddCallback PASS\n");
    return 0;
}
