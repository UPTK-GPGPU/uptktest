/*
 * Auto-generated smoke test for driver wrapper UPMemPoolExportPointer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKMemPoolPtrExportData local_shareData_out{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolExportPointer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolExportPointer(&local_shareData_out, dptr);

    printf("UPMemPoolExportPointer -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolExportPointer PASS\n");
    return 0;
}
