/*
 * Auto-generated smoke test for driver wrapper UPStreamWaitEvent_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamWaitEvent_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamWaitEvent_ptsz(stream, evt, 0u);

    printf("UPStreamWaitEvent_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamWaitEvent_ptsz PASS\n");
    return 0;
}
