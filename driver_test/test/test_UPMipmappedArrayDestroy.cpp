/*
 * Auto-generated smoke test for driver wrapper UPMipmappedArrayDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMipmappedArrayDestroy setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPMipmappedArrayDestroy PASS\n");
    return 0;
}
