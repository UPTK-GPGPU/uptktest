/*
 * Auto-generated smoke test for driver wrapper UPGraphMemFreeNodeGetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphMemFreeNodeGetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphMemFreeNodeGetParams(graphNode, &local_dptr_out);

    printf("UPGraphMemFreeNodeGetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphMemFreeNodeGetParams PASS\n");
    return 0;
}
