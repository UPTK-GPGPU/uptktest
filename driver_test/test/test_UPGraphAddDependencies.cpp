/*
 * Auto-generated smoke test for driver wrapper UPGraphAddDependencies (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphAddDependencies setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphAddDependencies(graph, &local_from, &local_to, (size_t)0);

    printf("UPGraphAddDependencies -> %d\n", (int)err);
    ...
    printf("test_UPGraphAddDependencies PASS\n");
    return 0;
}
