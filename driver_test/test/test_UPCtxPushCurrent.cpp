/*
 * Auto-generated smoke test for driver wrapper UPCtxPushCurrent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxPushCurrent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxPushCurrent(ctx);

    printf("UPCtxPushCurrent -> %d\n", (int)err);
    ...
    printf("test_UPCtxPushCurrent PASS\n");
    return 0;
}
