/*
 * Auto-generated smoke test for driver wrapper UPTexObjectDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexObjectDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexObjectDestroy(texObj);

    printf("UPTexObjectDestroy -> %d\n", (int)err);
    ...
    printf("test_UPTexObjectDestroy PASS\n");
    return 0;
}
