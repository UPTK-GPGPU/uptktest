/*
 * Auto-generated smoke test for driver wrapper UPGraphKernelNodeCopyAttributes (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphKernelNodeCopyAttributes setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphKernelNodeCopyAttributes(graphNode, graphNode);

    printf("UPGraphKernelNodeCopyAttributes -> %d\n", (int)err);
    ...
    printf("test_UPGraphKernelNodeCopyAttributes PASS\n");
    return 0;
}
