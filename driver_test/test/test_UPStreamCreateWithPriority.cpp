/*
 * Auto-generated smoke test for driver wrapper UPStreamCreateWithPriority (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamCreateWithPriority setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamCreateWithPriority(&local_phStream, 0u, 0);

    printf("UPStreamCreateWithPriority -> %d\n", (int)err);
    ...
    printf("test_UPStreamCreateWithPriority PASS\n");
    return 0;
}
