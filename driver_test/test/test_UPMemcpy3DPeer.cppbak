/*
 * Auto-generated smoke test for driver wrapper UPMemcpy3DPeer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy3DPeer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy3DPeer(&local_pCopy);

    printf("UPMemcpy3DPeer -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy3DPeer PASS\n");
    return 0;
}
