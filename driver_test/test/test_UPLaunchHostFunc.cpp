/*
 * Auto-generated smoke test for driver wrapper UPLaunchHostFunc (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchHostFunc setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLaunchHostFunc(stream, (UPTKhostFn)nullptr, (void*)nullptr);

    printf("UPLaunchHostFunc -> %d\n", (int)err);
    ...
    printf("test_UPLaunchHostFunc PASS\n");
    return 0;
}
