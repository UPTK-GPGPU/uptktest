/*
 * Auto-generated smoke test for driver wrapper UPStreamDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamDestroy(stream);

    printf("UPStreamDestroy -> %d\n", (int)err);
    ...
    printf("test_UPStreamDestroy PASS\n");
    return 0;
}
