/*
 * Auto-generated smoke test for driver wrapper UPCtxGetLimit (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetLimit setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetLimit(&local_pvalue, (UPTKlimit)UPTK_LIMIT_STACK_SIZE);

    printf("UPCtxGetLimit -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetLimit PASS\n");
    return 0;
}
