/*
 * Auto-generated smoke test for driver wrapper UPParamSeti (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPParamSeti setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPParamSeti(kern, 0, 0u);

    printf("UPParamSeti -> %d\n", (int)err);
