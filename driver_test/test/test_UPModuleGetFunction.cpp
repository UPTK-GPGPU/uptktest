/*
 * Auto-generated smoke test for driver wrapper UPModuleGetFunction (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleGetFunction setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleGetFunction(&local_hfunc, mod, &local_name);

    printf("UPModuleGetFunction -> %d\n", (int)err);
    ...
    printf("test_UPModuleGetFunction PASS\n");
    return 0;
}
