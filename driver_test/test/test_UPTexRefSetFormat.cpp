/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetFormat (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetFormat setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetFormat(texRef, (UPTKarray_format)0, 0);

    printf("UPTexRefSetFormat -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetFormat PASS\n");
    return 0;
}
