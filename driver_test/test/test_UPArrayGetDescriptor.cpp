/*
 * Auto-generated smoke test for driver wrapper UPArrayGetDescriptor (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_ARRAY_DESCRIPTOR local_pArrayDescriptor{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPArrayGetDescriptor setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPArrayGetDescriptor(&local_pArrayDescriptor, arr);

    printf("UPArrayGetDescriptor -> %d\n", (int)err);
    ...
    printf("test_UPArrayGetDescriptor PASS\n");
    return 0;
}
