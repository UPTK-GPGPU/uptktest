/*
 * Auto-generated smoke test for driver wrapper UPCtxSynchronize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxSynchronize setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxSynchronize();

    printf("UPCtxSynchronize -> %d\n", (int)err);
    ...
    printf("test_UPCtxSynchronize PASS\n");
    return 0;
}
