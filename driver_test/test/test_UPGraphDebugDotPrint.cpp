/*
 * Auto-generated smoke test for driver wrapper UPGraphDebugDotPrint (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphDebugDotPrint setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphDebugDotPrint(graph, &local_path, 0u);

    printf("UPGraphDebugDotPrint -> %d\n", (int)err);
    ...
    printf("test_UPGraphDebugDotPrint PASS\n");
    return 0;
}
