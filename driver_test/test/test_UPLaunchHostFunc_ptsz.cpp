/*
 * Auto-generated smoke test for driver wrapper UPLaunchHostFunc_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchHostFunc_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLaunchHostFunc_ptsz(stream, (UPTKhostFn)nullptr, (void*)nullptr);

    printf("UPLaunchHostFunc_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPLaunchHostFunc_ptsz PASS\n");
    return 0;
}
