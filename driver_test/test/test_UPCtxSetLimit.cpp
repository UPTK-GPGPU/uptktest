/*
 * Auto-generated smoke test for driver wrapper UPCtxSetLimit (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxSetLimit setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxSetLimit((UPTKlimit)UPTK_LIMIT_STACK_SIZE, (size_t)0);

    printf("UPCtxSetLimit -> %d\n", (int)err);
    ...
    printf("test_UPCtxSetLimit PASS\n");
    return 0;
}
