/*
 * Auto-generated smoke test for driver wrapper UPLinkComplete (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLinkComplete setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLinkComplete(linkState, (void**)nullptr, &local_sizeOut);

    printf("UPLinkComplete -> %d\n", (int)err);
    ...
    printf("test_UPLinkComplete PASS\n");
    return 0;
}
