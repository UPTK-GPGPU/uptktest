/*
 * Auto-generated smoke test for driver wrapper UPModuleLoadData (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleLoadData setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleLoadData(&local_module, (const void*)nullptr);

    printf("UPModuleLoadData -> %d\n", (int)err);
    ...
    printf("test_UPModuleLoadData PASS\n");
    return 0;
}
