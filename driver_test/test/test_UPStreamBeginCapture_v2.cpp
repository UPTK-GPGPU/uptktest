/*
 * Auto-generated smoke test for driver wrapper UPStreamBeginCapture_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamBeginCapture_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamBeginCapture_v2(stream, (UPTKStreamCaptureMode)0);

    printf("UPStreamBeginCapture_v2 -> %d\n", (int)err);
    ...
    printf("test_UPStreamBeginCapture_v2 PASS\n");
    return 0;
}
