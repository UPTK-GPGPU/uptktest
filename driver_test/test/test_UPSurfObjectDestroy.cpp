/*
 * Auto-generated smoke test for driver wrapper UPSurfObjectDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPSurfObjectDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPSurfObjectDestroy(surfObj);

    printf("UPSurfObjectDestroy -> %d\n", (int)err);
    ...
    printf("test_UPSurfObjectDestroy PASS\n");
    return 0;
}
