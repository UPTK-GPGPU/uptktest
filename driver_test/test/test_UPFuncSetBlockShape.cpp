/*
 * Auto-generated smoke test for driver wrapper UPFuncSetBlockShape (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFuncSetBlockShape setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPFuncSetBlockShape PASS\n");
    return 0;
}
