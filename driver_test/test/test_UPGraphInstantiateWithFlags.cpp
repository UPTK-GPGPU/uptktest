/*
 * Auto-generated smoke test for driver wrapper UPGraphInstantiateWithFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKGraphExec_t local_phGraphExec{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphInstantiateWithFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphInstantiateWithFlags(&local_phGraphExec, graph, 0ull);

    printf("UPGraphInstantiateWithFlags -> %d\n", (int)err);
    ...
    printf("test_UPGraphInstantiateWithFlags PASS\n");
    return 0;
}
