/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetMipmapLevelBias (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetMipmapLevelBias setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetMipmapLevelBias(texRef, 0.f);

    printf("UPTexRefSetMipmapLevelBias -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetMipmapLevelBias PASS\n");
    return 0;
}
