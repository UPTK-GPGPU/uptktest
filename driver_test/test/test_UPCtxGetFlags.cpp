/*
 * Auto-generated smoke test for driver wrapper UPCtxGetFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetFlags(&local_flags);

    printf("UPCtxGetFlags -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetFlags PASS\n");
    return 0;
}
