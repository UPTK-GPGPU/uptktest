/*
 * Auto-generated smoke test for driver wrapper UPGraphLaunch (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphLaunch setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphLaunch(graphExec, stream);

    printf("UPGraphLaunch -> %d\n", (int)err);
    ...
    printf("test_UPGraphLaunch PASS\n");
    return 0;
}
