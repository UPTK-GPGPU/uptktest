/*
 * Auto-generated smoke test for driver wrapper UPDeviceGet (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGet setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGet(&local_device, 0);

    printf("UPDeviceGet -> %d\n", (int)err);
