/*
 * Auto-generated smoke test for driver wrapper UPMemGetAddressRange_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemGetAddressRange_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemGetAddressRange_v2(&local_pbase, &local_psize, dptr);

    printf("UPMemGetAddressRange_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemGetAddressRange_v2 PASS\n");
    return 0;
}
