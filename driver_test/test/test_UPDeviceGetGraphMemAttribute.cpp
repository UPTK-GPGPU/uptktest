/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetGraphMemAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetGraphMemAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetGraphMemAttribute(dev, (UPTKgraphMem_attribute)0, (void*)nullptr);

    printf("UPDeviceGetGraphMemAttribute -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetGraphMemAttribute PASS\n");
    return 0;
}
