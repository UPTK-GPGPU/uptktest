/*
 * Auto-generated smoke test for driver wrapper UPMemsetD16Async (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD16Async setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD16Async(dptr, (unsigned short)0, (size_t)0, stream);

    printf("UPMemsetD16Async -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD16Async PASS\n");
    return 0;
}
