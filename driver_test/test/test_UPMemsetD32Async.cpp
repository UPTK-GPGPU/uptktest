/*
 * Auto-generated smoke test for driver wrapper UPMemsetD32Async (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD32Async setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD32Async(dptr, 0u, (size_t)0, stream);

    printf("UPMemsetD32Async -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD32Async PASS\n");
    return 0;
}
