/*
 * Auto-generated smoke test for driver wrapper UPCtxDisablePeerAccess (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxDisablePeerAccess setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxDisablePeerAccess(ctx);

    printf("UPCtxDisablePeerAccess -> %d\n", (int)err);
    ...
    printf("test_UPCtxDisablePeerAccess PASS\n");
    return 0;
}
