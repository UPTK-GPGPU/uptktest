/*
 * Auto-generated smoke test for driver wrapper UPStreamQuery (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamQuery setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamQuery(stream);

    printf("UPStreamQuery -> %d\n", (int)err);
    ...
    printf("test_UPStreamQuery PASS\n");
    return 0;
}
