/*
 * Auto-generated smoke test for driver wrapper UPMemAdvise (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAdvise setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAdvise(dptr, (size_t)0, (UPTKmem_advise)0, dev);

    printf("UPMemAdvise -> %d\n", (int)err);
