/*
 * Auto-generated smoke test for driver wrapper UPMemAllocFromPoolAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAllocFromPoolAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAllocFromPoolAsync_ptsz(&local_dptr, (size_t)0, memPool, stream);

    printf("UPMemAllocFromPoolAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemAllocFromPoolAsync_ptsz PASS\n");
    return 0;
}
