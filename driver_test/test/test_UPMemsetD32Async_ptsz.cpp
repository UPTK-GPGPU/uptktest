/*
 * Auto-generated smoke test for driver wrapper UPMemsetD32Async_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD32Async_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD32Async_ptsz(dptr, 0u, (size_t)0, stream);

    printf("UPMemsetD32Async_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD32Async_ptsz PASS\n");
    return 0;
}
