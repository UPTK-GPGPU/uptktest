/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetExecAffinitySupport (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetExecAffinitySupport setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetExecAffinitySupport(&local_pi, (UPTKexecAffinityType)0, dev);

    printf("UPDeviceGetExecAffinitySupport -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetExecAffinitySupport PASS\n");
    return 0;
}
