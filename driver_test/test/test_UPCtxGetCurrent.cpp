/*
 * Auto-generated smoke test for driver wrapper UPCtxGetCurrent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetCurrent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetCurrent(&local_pctx);

    printf("UPCtxGetCurrent -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetCurrent PASS\n");
    return 0;
}
