/*
 * Auto-generated smoke test for driver wrapper UPExternalMemoryGetMappedBuffer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_EXTERNAL_MEMORY_BUFFER_DESC local_bufferDesc{};
    UPTKdeviceptr local_devPtr{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPExternalMemoryGetMappedBuffer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPExternalMemoryGetMappedBuffer(&local_devPtr, extMem, &local_bufferDesc);

    printf("UPExternalMemoryGetMappedBuffer -> %d\n", (int)err);
    ...
    printf("test_UPExternalMemoryGetMappedBuffer PASS\n");
    return 0;
}
