/*
 * Auto-generated smoke test for driver wrapper UPProfilerStart (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPProfilerStart setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPProfilerStart();

    printf("UPProfilerStart -> %d\n", (int)err);
    ...
    printf("test_UPProfilerStart PASS\n");
    return 0;
}
