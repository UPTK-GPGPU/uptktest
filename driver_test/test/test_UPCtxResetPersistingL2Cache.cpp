/*
 * Auto-generated smoke test for driver wrapper UPCtxResetPersistingL2Cache (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxResetPersistingL2Cache setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxResetPersistingL2Cache();

    printf("UPCtxResetPersistingL2Cache -> %d\n", (int)err);
    ...
    printf("test_UPCtxResetPersistingL2Cache PASS\n");
    return 0;
}
