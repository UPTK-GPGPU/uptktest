/*
 * Auto-generated smoke test for driver wrapper UPGraphicsGLRegisterImage (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKGraphicsResource_t local_pCudaResource{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsGLRegisterImage setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsGLRegisterImage(&local_pCudaResource, (GLuint)0, (GLuint)0, 0u);

    printf("UPGraphicsGLRegisterImage -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsGLRegisterImage PASS\n");
    return 0;
}
