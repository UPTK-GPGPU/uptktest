/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetMipmapLevelClamp (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetMipmapLevelClamp setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetMipmapLevelClamp(texRef, 0.f, 0.f);

    printf("UPTexRefSetMipmapLevelClamp -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetMipmapLevelClamp PASS\n");
    return 0;
}
