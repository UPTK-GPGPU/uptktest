/*
 * Auto-generated smoke test for driver wrapper UPModuleGetTexRef (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleGetTexRef setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleGetTexRef(&local_pTexRef, mod, &local_name);

    printf("UPModuleGetTexRef -> %d\n", (int)err);
    ...
    printf("test_UPModuleGetTexRef PASS\n");
    return 0;
}
