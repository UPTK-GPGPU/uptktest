/*
 * Auto-generated smoke test for driver wrapper UPStreamGetPriority_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetPriority_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetPriority_ptsz(stream, &local_priority);

    printf("UPStreamGetPriority_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetPriority_ptsz PASS\n");
    return 0;
}
