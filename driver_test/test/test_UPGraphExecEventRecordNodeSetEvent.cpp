/*
 * Auto-generated smoke test for driver wrapper UPGraphExecEventRecordNodeSetEvent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphExecEventRecordNodeSetEvent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphExecEventRecordNodeSetEvent(graphExec, graphNode, evt);

    printf("UPGraphExecEventRecordNodeSetEvent -> %d\n", (int)err);
    ...
    printf("test_UPGraphExecEventRecordNodeSetEvent PASS\n");
    return 0;
}
