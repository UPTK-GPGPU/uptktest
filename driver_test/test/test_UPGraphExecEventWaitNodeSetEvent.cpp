/*
 * Auto-generated smoke test for driver wrapper UPGraphExecEventWaitNodeSetEvent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphExecEventWaitNodeSetEvent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphExecEventWaitNodeSetEvent(graphExec, graphNode, evt);

    printf("UPGraphExecEventWaitNodeSetEvent -> %d\n", (int)err);
    ...
    printf("test_UPGraphExecEventWaitNodeSetEvent PASS\n");
    return 0;
}
