/*
 * Auto-generated smoke test for driver wrapper UPLaunchCooperativeKernel_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchCooperativeKernel_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLaunchCooperativeKernel_ptsz(kern, 0u, 0u, 0u, 0u, 0u, 0u, 0u, stream, (void**)nullptr);

    printf("UPLaunchCooperativeKernel_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPLaunchCooperativeKernel_ptsz PASS\n");
    return 0;
}
