/*
 * Auto-generated smoke test for driver wrapper UPDestroyExternalSemaphore (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDestroyExternalSemaphore setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDestroyExternalSemaphore(extSem);

    printf("UPDestroyExternalSemaphore -> %d\n", (int)err);
    ...
    printf("test_UPDestroyExternalSemaphore PASS\n");
    return 0;
}
