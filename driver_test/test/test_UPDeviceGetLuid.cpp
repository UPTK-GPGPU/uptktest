/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetLuid (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    char local_luid{};
    unsigned int local_deviceNodeMask{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetLuid setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetLuid(&local_luid, &local_deviceNodeMask, dev);

    printf("UPDeviceGetLuid -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetLuid PASS\n");
    return 0;
}
