/*
 * Auto-generated smoke test for driver wrapper UPPointerSetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPPointerSetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPPointerSetAttribute((const void*)nullptr, (UPTKpointer_attribute)0, dptr);

    printf("UPPointerSetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPPointerSetAttribute PASS\n");
    return 0;
}
