/*
 * Auto-generated smoke test for driver wrapper UPGraphCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphCreate(&local_phGraph, 0u);

    printf("UPGraphCreate -> %d\n", (int)err);
    ...
    printf("test_UPGraphCreate PASS\n");
    return 0;
}
