/*
 * Auto-generated smoke test for driver wrapper UPMemcpy3DPeerAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_MEMCPY3D_PEER local_pCopy{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy3DPeerAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy3DPeerAsync_ptsz(&local_pCopy, stream);

    printf("UPMemcpy3DPeerAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy3DPeerAsync_ptsz PASS\n");
    return 0;
}
