/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetMipmapLevelClamp (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    float local_pmaxMipmapLevelClamp{};
    float local_pminMipmapLevelClamp{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetMipmapLevelClamp setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetMipmapLevelClamp(&local_pminMipmapLevelClamp, &local_pmaxMipmapLevelClamp, texRef);

    printf("UPTexRefGetMipmapLevelClamp -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetMipmapLevelClamp PASS\n");
    return 0;
}
