/*
 * Auto-generated smoke test for driver wrapper UPStreamSynchronize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamSynchronize setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamSynchronize(stream);

    printf("UPStreamSynchronize -> %d\n", (int)err);
    ...
    printf("test_UPStreamSynchronize PASS\n");
    return 0;
}
