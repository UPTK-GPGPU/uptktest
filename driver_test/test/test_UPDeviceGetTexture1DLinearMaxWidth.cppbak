/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetTexture1DLinearMaxWidth (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    size_t local_maxWidthInElements{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetTexture1DLinearMaxWidth setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetTexture1DLinearMaxWidth(&local_maxWidthInElements, (UPTKarray_format)0, (unsigned)0, dev);

    printf("UPDeviceGetTexture1DLinearMaxWidth -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetTexture1DLinearMaxWidth PASS\n");
    return 0;
}
