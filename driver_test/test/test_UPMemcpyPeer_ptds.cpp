/*
 * Auto-generated smoke test for driver wrapper UPMemcpyPeer_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyPeer_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyPeer_ptds(dptr, ctx, dptr, ctx, (size_t)0);

    printf("UPMemcpyPeer_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyPeer_ptds PASS\n");
    return 0;
}
