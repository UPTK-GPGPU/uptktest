/*
 * Auto-generated smoke test for driver wrapper UPDeviceGraphMemTrim (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGraphMemTrim setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGraphMemTrim(dev);

    printf("UPDeviceGraphMemTrim -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGraphMemTrim PASS\n");
    return 0;
}
