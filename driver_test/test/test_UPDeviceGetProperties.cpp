/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetProperties (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetProperties setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetProperties(&local_prop, dev);

    printf("UPDeviceGetProperties -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetProperties PASS\n");
    return 0;
}
