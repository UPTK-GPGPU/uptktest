/*
 * Auto-generated smoke test for driver wrapper UPEventQuery (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventQuery setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventQuery(evt);

    printf("UPEventQuery -> %d\n", (int)err);
