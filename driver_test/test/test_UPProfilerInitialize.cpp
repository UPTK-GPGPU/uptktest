/*
 * Auto-generated smoke test for driver wrapper UPProfilerInitialize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPProfilerInitialize setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPProfilerInitialize(&local_configFile, &local_outputFile, (UPTKoutput_mode)0);

    printf("UPProfilerInitialize -> %d\n", (int)err);
    ...
    printf("test_UPProfilerInitialize PASS\n");
    return 0;
}
