/*
 * Auto-generated smoke test for driver wrapper UPDevicePrimaryCtxRelease (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDevicePrimaryCtxRelease setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDevicePrimaryCtxRelease(dev);

    printf("UPDevicePrimaryCtxRelease -> %d\n", (int)err);
    ...
    printf("test_UPDevicePrimaryCtxRelease PASS\n");
    return 0;
}
