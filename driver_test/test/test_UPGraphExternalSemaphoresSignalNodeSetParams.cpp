/*
 * Auto-generated smoke test for driver wrapper UPGraphExternalSemaphoresSignalNodeSetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphExternalSemaphoresSignalNodeSetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphExternalSemaphoresSignalNodeSetParams(graphNode, &local_nodeParams);

    printf("UPGraphExternalSemaphoresSignalNodeSetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphExternalSemaphoresSignalNodeSetParams PASS\n");
    return 0;
}
