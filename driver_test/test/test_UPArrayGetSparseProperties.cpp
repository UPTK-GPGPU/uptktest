/*
 * Auto-generated smoke test for driver wrapper UPArrayGetSparseProperties (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPArrayGetSparseProperties setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPArrayGetSparseProperties(&local_sparseProperties, arr);

    printf("UPArrayGetSparseProperties -> %d\n", (int)err);
    ...
    printf("test_UPArrayGetSparseProperties PASS\n");
    return 0;
}
