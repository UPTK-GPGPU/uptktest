/*
 * Auto-generated smoke test for driver wrapper UPArrayGetPlane (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPArrayGetPlane setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPArrayGetPlane(&local_pPlaneArray, arr, 0u);

    printf("UPArrayGetPlane -> %d\n", (int)err);
    ...
    printf("test_UPArrayGetPlane PASS\n");
    return 0;
}
