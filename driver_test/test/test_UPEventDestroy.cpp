/*
 * Auto-generated smoke test for driver wrapper UPEventDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventDestroy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventDestroy(evt);

    printf("UPEventDestroy -> %d\n", (int)err);
    ...
    printf("test_UPEventDestroy PASS\n");
    return 0;
}
