/*
 * Auto-generated smoke test for driver wrapper UPCtxSetCacheConfig (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxSetCacheConfig setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxSetCacheConfig((UPTKfunc_cache)0);

    printf("UPCtxSetCacheConfig -> %d\n", (int)err);
    ...
    printf("test_UPCtxSetCacheConfig PASS\n");
    return 0;
}
