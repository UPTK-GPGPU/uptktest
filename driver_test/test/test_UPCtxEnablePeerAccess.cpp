/*
 * Auto-generated smoke test for driver wrapper UPCtxEnablePeerAccess (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxEnablePeerAccess setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxEnablePeerAccess(ctx, 0u);

    printf("UPCtxEnablePeerAccess -> %d\n", (int)err);
    ...
    printf("test_UPCtxEnablePeerAccess PASS\n");
    return 0;
}
