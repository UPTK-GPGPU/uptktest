/*
 * Auto-generated smoke test for driver wrapper UPStreamGetCtx_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetCtx_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetCtx_ptsz(stream, &local_pctx);

    printf("UPStreamGetCtx_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetCtx_ptsz PASS\n");
    return 0;
}
