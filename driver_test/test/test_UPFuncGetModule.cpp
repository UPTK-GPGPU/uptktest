/*
 * Auto-generated smoke test for driver wrapper UPFuncGetModule (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFuncGetModule setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPFuncGetModule PASS\n");
    return 0;
}
