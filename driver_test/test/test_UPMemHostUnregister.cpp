/*
 * Auto-generated smoke test for driver wrapper UPMemHostUnregister (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemHostUnregister setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemHostUnregister((void*)nullptr);

    printf("UPMemHostUnregister -> %d\n", (int)err);
    ...
    printf("test_UPMemHostUnregister PASS\n");
    return 0;
}
