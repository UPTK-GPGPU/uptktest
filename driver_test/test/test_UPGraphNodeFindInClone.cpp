/*
 * Auto-generated smoke test for driver wrapper UPGraphNodeFindInClone (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphNodeFindInClone setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphNodeFindInClone(&local_phNode, graphNode, graph);

    printf("UPGraphNodeFindInClone -> %d\n", (int)err);
    ...
    printf("test_UPGraphNodeFindInClone PASS\n");
    return 0;
}
