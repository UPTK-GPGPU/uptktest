/*
 * Auto-generated smoke test for driver wrapper UPGraphRemoveDependencies (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKGraphNode_t local_from{};
    UPTKGraphNode_t local_to{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphRemoveDependencies setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphRemoveDependencies(graph, &local_from, &local_to, (size_t)0);

    printf("UPGraphRemoveDependencies -> %d\n", (int)err);
    ...
    printf("test_UPGraphRemoveDependencies PASS\n");
    return 0;
}
