/*
 * Auto-generated smoke test for driver wrapper UPGraphicsResourceGetMappedMipmappedArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKMipmappedArray_t local_pMipmappedArray{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsResourceGetMappedMipmappedArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsResourceGetMappedMipmappedArray(&local_pMipmappedArray, gfxRes);

    printf("UPGraphicsResourceGetMappedMipmappedArray -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsResourceGetMappedMipmappedArray PASS\n");
    return 0;
}
