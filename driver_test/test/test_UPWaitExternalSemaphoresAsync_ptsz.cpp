/*
 * Auto-generated smoke test for driver wrapper UPWaitExternalSemaphoresAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_EXTERNAL_SEMAPHORE_WAIT_PARAMS local_paramsArray{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPWaitExternalSemaphoresAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPWaitExternalSemaphoresAsync_ptsz(&local_extSemArray, &local_paramsArray, 0u, stream);

    printf("UPWaitExternalSemaphoresAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPWaitExternalSemaphoresAsync_ptsz PASS\n");
    return 0;
}
