/*
 * Auto-generated smoke test for driver wrapper UPMemcpy3DPeerAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy3DPeerAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy3DPeerAsync(&local_pCopy, stream);

    printf("UPMemcpy3DPeerAsync -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy3DPeerAsync PASS\n");
    return 0;
}
