/*
 * Auto-generated smoke test for driver wrapper UPDriverGetVersion (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDriverGetVersion setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDriverGetVersion(&local_driverVersion);

    printf("UPDriverGetVersion -> %d\n", (int)err);
    ...
    printf("test_UPDriverGetVersion PASS\n");
    return 0;
}
