/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetP2PAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetP2PAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetP2PAttribute(&local_value, (UPTKdevice_P2PAttribute)0, dev, dev);

    printf("UPDeviceGetP2PAttribute -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetP2PAttribute PASS\n");
    return 0;
}
