/*
 * Auto-generated smoke test for driver wrapper UPMemPoolImportPointer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKdeviceptr local_ptr_out{};
    UPTKMemPoolPtrExportData local_shareData{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolImportPointer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolImportPointer(&local_ptr_out, memPool, &local_shareData);

    printf("UPMemPoolImportPointer -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolImportPointer PASS\n");
    return 0;
}
