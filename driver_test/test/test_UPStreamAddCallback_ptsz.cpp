/*
 * Auto-generated smoke test for driver wrapper UPStreamAddCallback_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamAddCallback_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamAddCallback_ptsz(stream, (UPTKstreamCallback)nullptr, (void*)nullptr, 0u);

    printf("UPStreamAddCallback_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamAddCallback_ptsz PASS\n");
    return 0;
}
