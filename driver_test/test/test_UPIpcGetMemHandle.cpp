/*
 * Auto-generated smoke test for driver wrapper UPIpcGetMemHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKIpcMemHandle_t local_pHandle{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPIpcGetMemHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPIpcGetMemHandle(&local_pHandle, dptr);

    printf("UPIpcGetMemHandle -> %d\n", (int)err);
    ...
    printf("test_UPIpcGetMemHandle PASS\n");
    return 0;
}
