/*
 * Auto-generated smoke test for driver wrapper UPGraphLaunch_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphLaunch_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphLaunch_ptsz(graphExec, stream);

    printf("UPGraphLaunch_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPGraphLaunch_ptsz PASS\n");
    return 0;
}
