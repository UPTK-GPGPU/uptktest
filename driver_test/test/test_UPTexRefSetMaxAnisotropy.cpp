/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetMaxAnisotropy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetMaxAnisotropy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetMaxAnisotropy(texRef, 0u);

    printf("UPTexRefSetMaxAnisotropy -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetMaxAnisotropy PASS\n");
    return 0;
}
