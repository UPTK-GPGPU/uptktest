/*
 * Auto-generated smoke test for driver wrapper UPStreamSetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamSetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamSetAttribute(stream, (UPTKStreamAttrID)0, &local_value);

    printf("UPStreamSetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPStreamSetAttribute PASS\n");
    return 0;
}
