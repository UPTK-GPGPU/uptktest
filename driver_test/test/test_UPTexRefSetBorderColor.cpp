/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetBorderColor (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetBorderColor setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetBorderColor(texRef, &local_pBorderColor);

    printf("UPTexRefSetBorderColor -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetBorderColor PASS\n");
    return 0;
}
