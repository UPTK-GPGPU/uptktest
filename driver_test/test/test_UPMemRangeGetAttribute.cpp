/*
 * Auto-generated smoke test for driver wrapper UPMemRangeGetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemRangeGetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemRangeGetAttribute((void*)nullptr, (size_t)0, (UPTKmem_range_attribute)0, dptr, (size_t)0);

    printf("UPMemRangeGetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPMemRangeGetAttribute PASS\n");
    return 0;
}
