/*
 * Auto-generated smoke test for driver wrapper UPMemAlloc_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAlloc_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAlloc_v2(&local_dptr, (size_t)0);

    printf("UPMemAlloc_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemAlloc_v2 PASS\n");
    return 0;
}
