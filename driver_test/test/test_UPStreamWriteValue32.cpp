/*
 * Auto-generated smoke test for driver wrapper UPStreamWriteValue32 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamWriteValue32 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamWriteValue32(stream, dptr, (cuuint32_t)0, 0u);

    printf("UPStreamWriteValue32 -> %d\n", (int)err);
    ...
    printf("test_UPStreamWriteValue32 PASS\n");
    return 0;
}
