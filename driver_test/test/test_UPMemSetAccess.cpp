/*
 * Auto-generated smoke test for driver wrapper UPMemSetAccess (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemSetAccess setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemSetAccess(dptr, (size_t)0, &local_desc, (size_t)0);

    printf("UPMemSetAccess -> %d\n", (int)err);
    ...
    printf("test_UPMemSetAccess PASS\n");
    return 0;
}
