/*
 * Auto-generated smoke test for driver wrapper UPGraphExecExternalSemaphoresWaitNodeSetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphExecExternalSemaphoresWaitNodeSetParams setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPGraphExecExternalSemaphoresWaitNodeSetParams PASS\n");
    return 0;
}
