/*
 * Auto-generated smoke test for driver wrapper UPMemcpy_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpy_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpy_ptds(dptr, dptr, (size_t)0);

    printf("UPMemcpy_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpy_ptds PASS\n");
    return 0;
}
