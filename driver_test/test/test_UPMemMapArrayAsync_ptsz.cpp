/*
 * Auto-generated smoke test for driver wrapper UPMemMapArrayAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKarrayMapInfo local_mapInfoList{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemMapArrayAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemMapArrayAsync_ptsz(&local_mapInfoList, 0u, stream);

    printf("UPMemMapArrayAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemMapArrayAsync_ptsz PASS\n");
    return 0;
}
