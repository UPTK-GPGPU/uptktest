/*
 * Auto-generated smoke test for driver wrapper UPMemAllocAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAllocAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAllocAsync_ptsz(&local_dptr, (size_t)0, stream);

    printf("UPMemAllocAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemAllocAsync_ptsz PASS\n");
    return 0;
}
