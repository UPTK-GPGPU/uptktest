/*
 * Auto-generated smoke test for driver wrapper UPTexRefDestroy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefDestroy setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPTexRefDestroy PASS\n");
    return 0;
}
