/*
 * Auto-generated smoke test for driver wrapper UPEventRecord_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventRecord_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventRecord_ptsz(evt, stream);

    printf("UPEventRecord_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPEventRecord_ptsz PASS\n");
    return 0;
}
