/*
 * Auto-generated smoke test for driver wrapper UPMemAllocPitch_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAllocPitch_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAllocPitch_v2(&local_dptr, &local_pPitch, (size_t)0, (size_t)0, 0u);

    printf("UPMemAllocPitch_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemAllocPitch_v2 PASS\n");
    return 0;
}
