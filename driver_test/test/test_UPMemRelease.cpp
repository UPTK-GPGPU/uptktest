/*
 * Auto-generated smoke test for driver wrapper UPMemRelease (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemRelease setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemRelease((UPTKmemGenericAllocationHandle)0);

    printf("UPMemRelease -> %d\n", (int)err);
