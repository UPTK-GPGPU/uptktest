/*
 * Auto-generated smoke test for driver wrapper UPStreamCopyAttributes (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamCopyAttributes setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamCopyAttributes(stream, stream);

    printf("UPStreamCopyAttributes -> %d\n", (int)err);
    ...
    printf("test_UPStreamCopyAttributes PASS\n");
    return 0;
}
