/*
 * Auto-generated smoke test for driver wrapper UPMemsetD2D8Async (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD2D8Async setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD2D8Async(dptr, (size_t)0, (unsigned char)0, (size_t)0, (size_t)0, stream);

    printf("UPMemsetD2D8Async -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD2D8Async PASS\n");
    return 0;
}
