/*
 * Auto-generated smoke test for driver wrapper UPGraphicsSubResourceGetMappedArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsSubResourceGetMappedArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsSubResourceGetMappedArray(&local_pArray, gfxRes, 0u, 0u);

    printf("UPGraphicsSubResourceGetMappedArray -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsSubResourceGetMappedArray PASS\n");
    return 0;
}
