/*
 * Auto-generated smoke test for driver wrapper UPStreamIsCapturing (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamIsCapturing setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamIsCapturing(stream, &local_captureStatus);

    printf("UPStreamIsCapturing -> %d\n", (int)err);
    ...
    printf("test_UPStreamIsCapturing PASS\n");
    return 0;
}
