/*
 * Auto-generated smoke test for driver wrapper UPUserObjectCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKUserObject_t local_object_out{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPUserObjectCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPUserObjectCreate(&local_object_out, (void*)nullptr, (UPTKhostFn)nullptr, 0u, 0u);

    printf("UPUserObjectCreate -> %d\n", (int)err);
    ...
    printf("test_UPUserObjectCreate PASS\n");
    return 0;
}
