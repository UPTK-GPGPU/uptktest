/*
 * Auto-generated smoke test for driver wrapper UPStreamQuery_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamQuery_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamQuery_ptsz(stream);

    printf("UPStreamQuery_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamQuery_ptsz PASS\n");
    return 0;
}
