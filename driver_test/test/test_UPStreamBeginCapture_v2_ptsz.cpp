/*
 * Auto-generated smoke test for driver wrapper UPStreamBeginCapture_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamBeginCapture_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamBeginCapture_v2_ptsz(stream, (UPTKStreamCaptureMode)0);

    printf("UPStreamBeginCapture_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamBeginCapture_v2_ptsz PASS\n");
    return 0;
}
