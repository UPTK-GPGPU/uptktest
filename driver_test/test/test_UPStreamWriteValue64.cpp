/*
 * Auto-generated smoke test for driver wrapper UPStreamWriteValue64 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamWriteValue64 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamWriteValue64(stream, dptr, (cuuint64_t)0, 0u);

    printf("UPStreamWriteValue64 -> %d\n", (int)err);
    ...
    printf("test_UPStreamWriteValue64 PASS\n");
    return 0;
}
