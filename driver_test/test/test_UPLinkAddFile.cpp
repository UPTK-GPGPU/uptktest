/*
 * Auto-generated smoke test for driver wrapper UPLinkAddFile (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLinkAddFile setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLinkAddFile(linkState, (UPTKjitInputType)0, &local_path, 0u, &local_options, (void**)nullptr);

    printf("UPLinkAddFile -> %d\n", (int)err);
    ...
    printf("test_UPLinkAddFile PASS\n");
    return 0;
}
