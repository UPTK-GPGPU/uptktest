/*
 * Auto-generated smoke test for driver wrapper UPOccupancyMaxActiveBlocksPerMultiprocessor (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPOccupancyMaxActiveBlocksPerMultiprocessor setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPOccupancyMaxActiveBlocksPerMultiprocessor(&local_numBlocks, kern, 0, (size_t)0);

    printf("UPOccupancyMaxActiveBlocksPerMultiprocessor -> %d\n", (int)err);
    ...
    printf("test_UPOccupancyMaxActiveBlocksPerMultiprocessor PASS\n");
    return 0;
}
