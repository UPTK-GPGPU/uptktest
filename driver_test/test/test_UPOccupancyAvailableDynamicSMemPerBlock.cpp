/*
 * Auto-generated smoke test for driver wrapper UPOccupancyAvailableDynamicSMemPerBlock (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPOccupancyAvailableDynamicSMemPerBlock setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPOccupancyAvailableDynamicSMemPerBlock(&local_dynamicSmemSize, kern, 0, 0);

    printf("UPOccupancyAvailableDynamicSMemPerBlock -> %d\n", (int)err);
    ...
    printf("test_UPOccupancyAvailableDynamicSMemPerBlock PASS\n");
    return 0;
}
