/*
 * Auto-generated smoke test for driver wrapper UPGraphicsGLRegisterBuffer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsGLRegisterBuffer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsGLRegisterBuffer(&local_pCudaResource, (GLuint)0, 0u);

    printf("UPGraphicsGLRegisterBuffer -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsGLRegisterBuffer PASS\n");
    return 0;
}
