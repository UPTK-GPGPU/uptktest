/*
 * Auto-generated smoke test for driver wrapper UPModuleGetLoadingMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKmoduleLoadingMode local_mode{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleGetLoadingMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleGetLoadingMode(&local_mode);

    printf("UPModuleGetLoadingMode -> %d\n", (int)err);
    ...
    printf("test_UPModuleGetLoadingMode PASS\n");
    return 0;
}
