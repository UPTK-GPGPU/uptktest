/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoDAsync_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoDAsync_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoDAsync_v2_ptsz(dptr, dptr, (size_t)0, stream);

    printf("UPMemcpyDtoDAsync_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoDAsync_v2_ptsz PASS\n");
    return 0;
}
