/*
 * Auto-generated smoke test for driver wrapper UPStreamAttachMemAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamAttachMemAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamAttachMemAsync_ptsz(stream, dptr, (size_t)0, 0u);

    printf("UPStreamAttachMemAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamAttachMemAsync_ptsz PASS\n");
    return 0;
}
