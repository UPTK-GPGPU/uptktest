/*
 * Auto-generated smoke test for driver wrapper UPGraphExecChildGraphNodeSetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphExecChildGraphNodeSetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphExecChildGraphNodeSetParams(graphExec, graphNode, graph);

    printf("UPGraphExecChildGraphNodeSetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphExecChildGraphNodeSetParams PASS\n");
    return 0;
}
