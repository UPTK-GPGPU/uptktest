/*
 * Auto-generated smoke test for driver wrapper UPMemUnmap (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemUnmap setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemUnmap(dptr, (size_t)0);
