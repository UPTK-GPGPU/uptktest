/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetArray(texRef, arr, 0u);

    printf("UPTexRefSetArray -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetArray PASS\n");
    return 0;
}
