/*
 * Auto-generated smoke test for driver wrapper UPFuncGetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFuncGetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPFuncGetAttribute PASS\n");
    return 0;
}
