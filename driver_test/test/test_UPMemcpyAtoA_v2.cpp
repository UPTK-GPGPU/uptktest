/*
 * Auto-generated smoke test for driver wrapper UPMemcpyAtoA_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyAtoA_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyAtoA_v2(arr, (size_t)0, arr, (size_t)0, (size_t)0);

    printf("UPMemcpyAtoA_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyAtoA_v2 PASS\n");
    return 0;
}
