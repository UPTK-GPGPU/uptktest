/*
 * Auto-generated smoke test for driver wrapper UPGraphReleaseUserObject (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphReleaseUserObject setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphReleaseUserObject(graph, userObj, 0u);

    printf("UPGraphReleaseUserObject -> %d\n", (int)err);
    ...
    printf("test_UPGraphReleaseUserObject PASS\n");
    return 0;
}
