/*
 * Auto-generated smoke test for driver wrapper UPDeviceCanAccessPeer (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceCanAccessPeer setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceCanAccessPeer(&local_canAccessPeer, dev, dev);

    printf("UPDeviceCanAccessPeer -> %d\n", (int)err);
    ...
    printf("test_UPDeviceCanAccessPeer PASS\n");
    return 0;
}
