/*
 * Auto-generated smoke test for driver wrapper UPCtxGetApiVersion (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetApiVersion setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetApiVersion(ctx, &local_version);

    printf("UPCtxGetApiVersion -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetApiVersion PASS\n");
    return 0;
}
