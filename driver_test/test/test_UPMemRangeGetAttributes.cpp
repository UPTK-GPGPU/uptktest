/*
 * Auto-generated smoke test for driver wrapper UPMemRangeGetAttributes (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    size_t local_dataSizes{};
    UPTKmem_range_attribute local_attributes{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemRangeGetAttributes setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemRangeGetAttributes((void**)nullptr, &local_dataSizes, &local_attributes, (size_t)0, dptr, (size_t)0);

    printf("UPMemRangeGetAttributes -> %d\n", (int)err);
    ...
    printf("test_UPMemRangeGetAttributes PASS\n");
    return 0;
}
