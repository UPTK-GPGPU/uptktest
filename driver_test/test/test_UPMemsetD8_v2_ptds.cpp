/*
 * Auto-generated smoke test for driver wrapper UPMemsetD8_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD8_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD8_v2_ptds(dptr, (unsigned char)0, (size_t)0);

    printf("UPMemsetD8_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD8_v2_ptds PASS\n");
    return 0;
}
