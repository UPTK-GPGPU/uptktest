/*
 * Auto-generated smoke test for driver wrapper UPStreamWaitValue32 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamWaitValue32 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamWaitValue32(stream, dptr, (cuuint32_t)0, 0u);

    printf("UPStreamWaitValue32 -> %d\n", (int)err);
    ...
    printf("test_UPStreamWaitValue32 PASS\n");
    return 0;
}
