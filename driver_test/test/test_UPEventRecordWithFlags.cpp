/*
 * Auto-generated smoke test for driver wrapper UPEventRecordWithFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventRecordWithFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventRecordWithFlags(evt, stream, 0u);

    printf("UPEventRecordWithFlags -> %d\n", (int)err);
    ...
    printf("test_UPEventRecordWithFlags PASS\n");
    return 0;
}
