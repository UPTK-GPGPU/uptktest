/*
 * Auto-generated smoke test for driver wrapper UPGraphEventRecordNodeSetEvent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphEventRecordNodeSetEvent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphEventRecordNodeSetEvent(graphNode, evt);

    printf("UPGraphEventRecordNodeSetEvent -> %d\n", (int)err);
    ...
    printf("test_UPGraphEventRecordNodeSetEvent PASS\n");
    return 0;
}
