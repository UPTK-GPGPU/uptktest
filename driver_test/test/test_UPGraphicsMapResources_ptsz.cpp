/*
 * Auto-generated smoke test for driver wrapper UPGraphicsMapResources_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsMapResources_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsMapResources_ptsz(0u, &local_resources, stream);

    printf("UPGraphicsMapResources_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsMapResources_ptsz PASS\n");
    return 0;
}
