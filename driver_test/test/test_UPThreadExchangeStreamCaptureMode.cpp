/*
 * Auto-generated smoke test for driver wrapper UPThreadExchangeStreamCaptureMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKStreamCaptureMode local_mode{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPThreadExchangeStreamCaptureMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPThreadExchangeStreamCaptureMode(&local_mode);

    printf("UPThreadExchangeStreamCaptureMode -> %d\n", (int)err);
    ...
    printf("test_UPThreadExchangeStreamCaptureMode PASS\n");
    return 0;
}
