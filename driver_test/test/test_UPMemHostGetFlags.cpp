/*
 * Auto-generated smoke test for driver wrapper UPMemHostGetFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemHostGetFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemHostGetFlags(&local_pFlags, (void*)nullptr);

    printf("UPMemHostGetFlags -> %d\n", (int)err);
    ...
    printf("test_UPMemHostGetFlags PASS\n");
    return 0;
}
