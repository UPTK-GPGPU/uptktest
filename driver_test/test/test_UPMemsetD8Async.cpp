/*
 * Auto-generated smoke test for driver wrapper UPMemsetD8Async (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD8Async setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD8Async(dptr, (unsigned char)0, (size_t)0, stream);

    printf("UPMemsetD8Async -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD8Async PASS\n");
    return 0;
}
