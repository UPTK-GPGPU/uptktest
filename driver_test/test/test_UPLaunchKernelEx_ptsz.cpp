/*
 * Auto-generated smoke test for driver wrapper UPLaunchKernelEx_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchKernelEx_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLaunchKernelEx_ptsz(&local_config, kern, (void**)nullptr, (void**)nullptr);

    printf("UPLaunchKernelEx_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPLaunchKernelEx_ptsz PASS\n");
    return 0;
}
