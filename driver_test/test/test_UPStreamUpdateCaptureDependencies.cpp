/*
 * Auto-generated smoke test for driver wrapper UPStreamUpdateCaptureDependencies (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamUpdateCaptureDependencies setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamUpdateCaptureDependencies(stream, &local_dependencies, (size_t)0, 0u);

    printf("UPStreamUpdateCaptureDependencies -> %d\n", (int)err);
    ...
    printf("test_UPStreamUpdateCaptureDependencies PASS\n");
    return 0;
}
