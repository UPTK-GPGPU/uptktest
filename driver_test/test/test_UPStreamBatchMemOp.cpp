/*
 * Auto-generated smoke test for driver wrapper UPStreamBatchMemOp (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamBatchMemOp setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamBatchMemOp(stream, 0u, &local_paramArray, 0u);

    printf("UPStreamBatchMemOp -> %d\n", (int)err);
    ...
    printf("test_UPStreamBatchMemOp PASS\n");
    return 0;
}
