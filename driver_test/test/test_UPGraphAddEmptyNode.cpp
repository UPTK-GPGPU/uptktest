/*
 * Auto-generated smoke test for driver wrapper UPGraphAddEmptyNode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphAddEmptyNode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphAddEmptyNode(&local_phGraphNode, graph, &local_dependencies, (size_t)0);

    printf("UPGraphAddEmptyNode -> %d\n", (int)err);
    ...
    printf("test_UPGraphAddEmptyNode PASS\n");
    return 0;
}
