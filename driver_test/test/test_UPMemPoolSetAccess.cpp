/*
 * Auto-generated smoke test for driver wrapper UPMemPoolSetAccess (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolSetAccess setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolSetAccess(memPool, &local_map, (size_t)0);

    printf("UPMemPoolSetAccess -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolSetAccess PASS\n");
    return 0;
}
