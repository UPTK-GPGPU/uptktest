/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetAddress_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetAddress_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetAddress_v2(&local_ByteOffset, texRef, dptr, (size_t)0);

    printf("UPTexRefSetAddress_v2 -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetAddress_v2 PASS\n");
    return 0;
}
