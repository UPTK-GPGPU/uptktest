/*
 * Auto-generated smoke test for driver wrapper UPGraphicsResourceSetMapFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsResourceSetMapFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsResourceSetMapFlags(gfxRes, 0u);

    printf("UPGraphicsResourceSetMapFlags -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsResourceSetMapFlags PASS\n");
    return 0;
}
