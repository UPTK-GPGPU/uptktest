/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoH_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoH_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoH_v2((void*)nullptr, dptr, (size_t)0);

    printf("UPMemcpyDtoH_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoH_v2 PASS\n");
    return 0;
}
