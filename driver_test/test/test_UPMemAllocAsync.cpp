/*
 * Auto-generated smoke test for driver wrapper UPMemAllocAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAllocAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAllocAsync(&local_dptr, (size_t)0, stream);

    printf("UPMemAllocAsync -> %d\n", (int)err);
    ...
    printf("test_UPMemAllocAsync PASS\n");
    return 0;
}
