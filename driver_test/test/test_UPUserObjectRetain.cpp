/*
 * Auto-generated smoke test for driver wrapper UPUserObjectRetain (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPUserObjectRetain setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPUserObjectRetain(userObj, 0u);

    printf("UPUserObjectRetain -> %d\n", (int)err);
    ...
    printf("test_UPUserObjectRetain PASS\n");
    return 0;
}
