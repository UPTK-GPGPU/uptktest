/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetMaxAnisotropy (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetMaxAnisotropy setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetMaxAnisotropy(&local_pmaxAniso, texRef);

    printf("UPTexRefGetMaxAnisotropy -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetMaxAnisotropy PASS\n");
    return 0;
}
