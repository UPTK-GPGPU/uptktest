/*
 * Auto-generated smoke test for driver wrapper UPMemAllocManaged (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAllocManaged setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAllocManaged(&local_dptr, (size_t)0, 0u);

    printf("UPMemAllocManaged -> %d\n", (int)err);
    ...
    printf("test_UPMemAllocManaged PASS\n");
    return 0;
}
