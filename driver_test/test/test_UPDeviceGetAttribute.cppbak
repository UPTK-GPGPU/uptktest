/*
 * Auto-generated smoke test for driver wrapper UPDeviceGetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceGetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceGetAttribute(&local_pi, (UPTKDeviceAttr)0, dev);

    printf("UPDeviceGetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPDeviceGetAttribute PASS\n");
    return 0;
}
