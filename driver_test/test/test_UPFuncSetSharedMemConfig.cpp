/*
 * Auto-generated smoke test for driver wrapper UPFuncSetSharedMemConfig (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFuncSetSharedMemConfig setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPFuncSetSharedMemConfig(kern, (UPTKsharedconfig)0);

    printf("UPFuncSetSharedMemConfig -> %d\n", (int)err);
    ...
    printf("test_UPFuncSetSharedMemConfig PASS\n");
    return 0;
}
