/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoHAsync_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoHAsync_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoHAsync_v2_ptsz((void*)nullptr, dptr, (size_t)0, stream);

    printf("UPMemcpyDtoHAsync_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoHAsync_v2_ptsz PASS\n");
    return 0;
}
