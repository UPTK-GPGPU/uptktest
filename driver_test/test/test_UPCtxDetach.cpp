/*
 * Auto-generated smoke test for driver wrapper UPCtxDetach (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxDetach setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxDetach(ctx);

    printf("UPCtxDetach -> %d\n", (int)err);
