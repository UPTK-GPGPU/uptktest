/*
 * Auto-generated smoke test for driver wrapper UPCtxGetStreamPriorityRange (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    int local_greatestPriority{};
    int local_leastPriority{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetStreamPriorityRange setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetStreamPriorityRange(&local_leastPriority, &local_greatestPriority);

    printf("UPCtxGetStreamPriorityRange -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetStreamPriorityRange PASS\n");
    return 0;
}
