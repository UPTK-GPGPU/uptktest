/*
 * Auto-generated smoke test for driver wrapper UPSurfObjectGetResourceDesc (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPSurfObjectGetResourceDesc setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPSurfObjectGetResourceDesc(&local_pResDesc, surfObj);

    printf("UPSurfObjectGetResourceDesc -> %d\n", (int)err);
    ...
    printf("test_UPSurfObjectGetResourceDesc PASS\n");
    return 0;
}
