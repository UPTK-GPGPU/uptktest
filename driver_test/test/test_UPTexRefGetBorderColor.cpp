/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetBorderColor (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetBorderColor setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetBorderColor(&local_pBorderColor, texRef);

    printf("UPTexRefGetBorderColor -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetBorderColor PASS\n");
    return 0;
}
