/*
 * Auto-generated smoke test for driver wrapper UPExternalMemoryGetMappedMipmappedArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_EXTERNAL_MEMORY_MIPMAPPED_ARRAY_DESC local_mipmapDesc{};
    UPTKMipmappedArray_t local_mipmap{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPExternalMemoryGetMappedMipmappedArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPExternalMemoryGetMappedMipmappedArray(&local_mipmap, extMem, &local_mipmapDesc);

    printf("UPExternalMemoryGetMappedMipmappedArray -> %d\n", (int)err);
    ...
    printf("test_UPExternalMemoryGetMappedMipmappedArray PASS\n");
    return 0;
}
