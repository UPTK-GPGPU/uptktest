/*
 * Auto-generated smoke test for driver wrapper UPTexObjectGetResourceViewDesc (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexObjectGetResourceViewDesc setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexObjectGetResourceViewDesc(&local_pResViewDesc, texObj);

    printf("UPTexObjectGetResourceViewDesc -> %d\n", (int)err);
    ...
    printf("test_UPTexObjectGetResourceViewDesc PASS\n");
    return 0;
}
