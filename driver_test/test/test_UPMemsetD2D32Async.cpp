/*
 * Auto-generated smoke test for driver wrapper UPMemsetD2D32Async (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD2D32Async setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD2D32Async(dptr, (size_t)0, 0u, (size_t)0, (size_t)0, stream);

    printf("UPMemsetD2D32Async -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD2D32Async PASS\n");
    return 0;
}
