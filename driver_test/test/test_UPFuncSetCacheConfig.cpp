/*
 * Auto-generated smoke test for driver wrapper UPFuncSetCacheConfig (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFuncSetCacheConfig setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPFuncSetCacheConfig(kern, (UPTKfunc_cache)0);

    printf("UPFuncSetCacheConfig -> %d\n", (int)err);
    ...
    printf("test_UPFuncSetCacheConfig PASS\n");
    return 0;
}
