/*
 * Auto-generated smoke test for driver wrapper UPMemPoolExportToShareableHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolExportToShareableHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemPoolExportToShareableHandle((void*)nullptr, memPool, (UPTKMemAllocationHandleType)0, 0ull);

    printf("UPMemPoolExportToShareableHandle -> %d\n", (int)err);
    ...
    printf("test_UPMemPoolExportToShareableHandle PASS\n");
    return 0;
}
