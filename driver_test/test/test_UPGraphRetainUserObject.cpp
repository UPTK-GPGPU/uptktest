/*
 * Auto-generated smoke test for driver wrapper UPGraphRetainUserObject (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphRetainUserObject setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphRetainUserObject(graph, userObj, 0u, 0u);

    printf("UPGraphRetainUserObject -> %d\n", (int)err);
    ...
    printf("test_UPGraphRetainUserObject PASS\n");
    return 0;
}
