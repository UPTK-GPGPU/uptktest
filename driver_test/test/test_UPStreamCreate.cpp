/*
 * Auto-generated smoke test for driver wrapper UPStreamCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamCreate(&local_phStream, 0u);

    printf("UPStreamCreate -> %d\n", (int)err);
    ...
    printf("test_UPStreamCreate PASS\n");
    return 0;
}
