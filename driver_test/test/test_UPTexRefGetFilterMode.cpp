/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetFilterMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetFilterMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetFilterMode(&local_pfm, texRef);

    printf("UPTexRefGetFilterMode -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetFilterMode PASS\n");
    return 0;
}
