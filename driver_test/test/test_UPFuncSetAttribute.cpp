/*
 * Auto-generated smoke test for driver wrapper UPFuncSetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFuncSetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPFuncSetAttribute(kern, (UPTKfunction_attribute)0, 0);

    printf("UPFuncSetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPFuncSetAttribute PASS\n");
    return 0;
}
