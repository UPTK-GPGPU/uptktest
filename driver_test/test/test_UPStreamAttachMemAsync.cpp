/*
 * Auto-generated smoke test for driver wrapper UPStreamAttachMemAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamAttachMemAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamAttachMemAsync(stream, dptr, (size_t)0, 0u);

    printf("UPStreamAttachMemAsync -> %d\n", (int)err);
    ...
    printf("test_UPStreamAttachMemAsync PASS\n");
    return 0;
}
