/*
 * Auto-generated smoke test for driver wrapper UPMemcpyAtoD_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyAtoD_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyAtoD_v2(dptr, arr, (size_t)0, (size_t)0);

    printf("UPMemcpyAtoD_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyAtoD_v2 PASS\n");
    return 0;
}
