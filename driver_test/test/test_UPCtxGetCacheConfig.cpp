/*
 * Auto-generated smoke test for driver wrapper UPCtxGetCacheConfig (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetCacheConfig setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetCacheConfig(&local_pconfig);

    printf("UPCtxGetCacheConfig -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetCacheConfig PASS\n");
    return 0;
}
