/*
 * Auto-generated smoke test for driver wrapper UPStreamWaitValue32_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamWaitValue32_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamWaitValue32_v2_ptsz(stream, dptr, (cuuint32_t)0, 0u);

    printf("UPStreamWaitValue32_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamWaitValue32_v2_ptsz PASS\n");
    return 0;
}
