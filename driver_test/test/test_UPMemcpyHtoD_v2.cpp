/*
 * Auto-generated smoke test for driver wrapper UPMemcpyHtoD_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyHtoD_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyHtoD_v2(dptr, (const void*)nullptr, (size_t)0);

    printf("UPMemcpyHtoD_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyHtoD_v2 PASS\n");
    return 0;
}
