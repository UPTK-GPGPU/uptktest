/*
 * Auto-generated smoke test for driver wrapper UPMemcpyAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyAsync_ptsz(dptr, dptr, (size_t)0, stream);

    printf("UPMemcpyAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyAsync_ptsz PASS\n");
    return 0;
}
