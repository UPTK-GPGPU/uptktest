/*
 * Auto-generated smoke test for driver wrapper UPLaunchKernelEx (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchKernelEx setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLaunchKernelEx(&local_config, kern, (void**)nullptr, (void**)nullptr);

    printf("UPLaunchKernelEx -> %d\n", (int)err);
    ...
    printf("test_UPLaunchKernelEx PASS\n");
    return 0;
}
