/*
 * Auto-generated smoke test for driver wrapper UPTexRefCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefCreate(&local_pTexRef);

    printf("UPTexRefCreate -> %d\n", (int)err);
    ...
    printf("test_UPTexRefCreate PASS\n");
    return 0;
}
