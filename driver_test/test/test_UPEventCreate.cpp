/*
 * Auto-generated smoke test for driver wrapper UPEventCreate (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventCreate setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventCreate(&local_phEvent, 0u);

    printf("UPEventCreate -> %d\n", (int)err);
    ...
    printf("test_UPEventCreate PASS\n");
    return 0;
}
