/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoA_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoA_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoA_v2(arr, (size_t)0, dptr, (size_t)0);

    printf("UPMemcpyDtoA_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoA_v2 PASS\n");
    return 0;
}
