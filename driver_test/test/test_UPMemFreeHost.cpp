/*
 * Auto-generated smoke test for driver wrapper UPMemFreeHost (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemFreeHost setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemFreeHost((void*)nullptr);

    printf("UPMemFreeHost -> %d\n", (int)err);
    ...
    printf("test_UPMemFreeHost PASS\n");
    return 0;
}
