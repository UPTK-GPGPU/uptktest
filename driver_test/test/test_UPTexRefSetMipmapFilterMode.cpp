/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetMipmapFilterMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetMipmapFilterMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetMipmapFilterMode(texRef, (UPTKfilter_mode)0);

    printf("UPTexRefSetMipmapFilterMode -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetMipmapFilterMode PASS\n");
    return 0;
}
