/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoD_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoD_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoD_v2_ptds(dptr, dptr, (size_t)0);

    printf("UPMemcpyDtoD_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoD_v2_ptds PASS\n");
    return 0;
}
