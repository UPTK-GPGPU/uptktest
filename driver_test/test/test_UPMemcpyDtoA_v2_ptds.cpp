/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoA_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoA_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoA_v2_ptds(arr, (size_t)0, dptr, (size_t)0);

    printf("UPMemcpyDtoA_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoA_v2_ptds PASS\n");
    return 0;
}
