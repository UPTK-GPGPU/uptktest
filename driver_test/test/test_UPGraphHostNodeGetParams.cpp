/*
 * Auto-generated smoke test for driver wrapper UPGraphHostNodeGetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphHostNodeGetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphHostNodeGetParams(graphNode, &local_nodeParams);

    printf("UPGraphHostNodeGetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphHostNodeGetParams PASS\n");
    return 0;
}
