/*
 * Auto-generated smoke test for driver wrapper UPTexObjectGetResourceDesc (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexObjectGetResourceDesc setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexObjectGetResourceDesc(&local_pResDesc, texObj);

    printf("UPTexObjectGetResourceDesc -> %d\n", (int)err);
    ...
    printf("test_UPTexObjectGetResourceDesc PASS\n");
    return 0;
}
