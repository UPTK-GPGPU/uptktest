/*
 * Auto-generated smoke test for driver wrapper UPIpcCloseMemHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPIpcCloseMemHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPIpcCloseMemHandle(dptr);

    printf("UPIpcCloseMemHandle -> %d\n", (int)err);
    ...
    printf("test_UPIpcCloseMemHandle PASS\n");
    return 0;
}
