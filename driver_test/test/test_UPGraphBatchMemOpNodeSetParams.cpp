/*
 * Auto-generated smoke test for driver wrapper UPGraphBatchMemOpNodeSetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphBatchMemOpNodeSetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphBatchMemOpNodeSetParams(graphNode, &local_nodeParams);

    printf("UPGraphBatchMemOpNodeSetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphBatchMemOpNodeSetParams PASS\n");
    return 0;
}
