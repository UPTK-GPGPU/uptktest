/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetMipmapLevelBias (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetMipmapLevelBias setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetMipmapLevelBias(&local_pbias, texRef);

    printf("UPTexRefGetMipmapLevelBias -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetMipmapLevelBias PASS\n");
    return 0;
}
