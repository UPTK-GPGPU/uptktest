/*
 * Auto-generated smoke test for driver wrapper UPDeviceSetGraphMemAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceSetGraphMemAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceSetGraphMemAttribute(dev, (UPTKgraphMem_attribute)0, (void*)nullptr);

    printf("UPDeviceSetGraphMemAttribute -> %d\n", (int)err);
    ...
    printf("test_UPDeviceSetGraphMemAttribute PASS\n");
    return 0;
}
