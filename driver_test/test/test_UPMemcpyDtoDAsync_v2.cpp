/*
 * Auto-generated smoke test for driver wrapper UPMemcpyDtoDAsync_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyDtoDAsync_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyDtoDAsync_v2(dptr, dptr, (size_t)0, stream);

    printf("UPMemcpyDtoDAsync_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyDtoDAsync_v2 PASS\n");
    return 0;
}
