/*
 * Auto-generated smoke test for driver wrapper UPMemcpyAtoHAsync_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyAtoHAsync_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyAtoHAsync_v2((void*)nullptr, arr, (size_t)0, (size_t)0, stream);

    printf("UPMemcpyAtoHAsync_v2 -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyAtoHAsync_v2 PASS\n");
    return 0;
}
