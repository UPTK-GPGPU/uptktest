/*
 * Auto-generated smoke test for driver wrapper UPGraphMemAllocNodeGetParams (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_MEM_ALLOC_NODE_PARAMS local_params_out{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphMemAllocNodeGetParams setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphMemAllocNodeGetParams(graphNode, &local_params_out);

    printf("UPGraphMemAllocNodeGetParams -> %d\n", (int)err);
    ...
    printf("test_UPGraphMemAllocNodeGetParams PASS\n");
    return 0;
}
