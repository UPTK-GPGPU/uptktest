/*
 * Auto-generated smoke test for driver wrapper UPOccupancyMaxPotentialClusterSize (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    int local_clusterSize{};
    UPTKLaunchConfig_t local_config{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPOccupancyMaxPotentialClusterSize setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPOccupancyMaxPotentialClusterSize(&local_clusterSize, kern, &local_config);

    printf("UPOccupancyMaxPotentialClusterSize -> %d\n", (int)err);
    ...
    printf("test_UPOccupancyMaxPotentialClusterSize PASS\n");
    return 0;
}
