/*
 * Auto-generated smoke test for driver wrapper UPFlushGPUDirectRDMAWrites (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPFlushGPUDirectRDMAWrites setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPFlushGPUDirectRDMAWrites((UPTKFlushGPUDirectRDMAWritesTarget)0, (UPTKFlushGPUDirectRDMAWritesScope)0);

    printf("UPFlushGPUDirectRDMAWrites -> %d\n", (int)err);
    ...
    printf("test_UPFlushGPUDirectRDMAWrites PASS\n");
    return 0;
}
