/*
 * Auto-generated smoke test for driver wrapper UPProfilerStop (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPProfilerStop setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPProfilerStop();

    printf("UPProfilerStop -> %d\n", (int)err);
    ...
    printf("test_UPProfilerStop PASS\n");
    return 0;
}
