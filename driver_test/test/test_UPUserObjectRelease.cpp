/*
 * Auto-generated smoke test for driver wrapper UPUserObjectRelease (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPUserObjectRelease setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPUserObjectRelease(userObj, 0u);

    printf("UPUserObjectRelease -> %d\n", (int)err);
    ...
    printf("test_UPUserObjectRelease PASS\n");
    return 0;
}
