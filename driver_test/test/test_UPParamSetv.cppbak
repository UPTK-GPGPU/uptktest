/*
 * Auto-generated smoke test for driver wrapper UPParamSetv (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPParamSetv setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPParamSetv(kern, 0, (void*)nullptr, 0u);

    printf("UPParamSetv -> %d\n", (int)err);
