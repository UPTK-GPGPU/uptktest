/*
 * Auto-generated smoke test for driver wrapper UPMemHostRegister (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemHostRegister setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemHostRegister((void*)nullptr, (size_t)0, 0u);

    printf("UPMemHostRegister -> %d\n", (int)err);
    ...
    printf("test_UPMemHostRegister PASS\n");
    return 0;
}
