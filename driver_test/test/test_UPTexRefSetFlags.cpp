/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetFlags(texRef, 0u);

    printf("UPTexRefSetFlags -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetFlags PASS\n");
    return 0;
}
