/*
 * Auto-generated smoke test for driver wrapper UPStreamBatchMemOp_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKstreamBatchMemOpParams local_paramArray{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamBatchMemOp_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamBatchMemOp_v2_ptsz(stream, 0u, &local_paramArray, 0u);

    printf("UPStreamBatchMemOp_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamBatchMemOp_v2_ptsz PASS\n");
    return 0;
}
