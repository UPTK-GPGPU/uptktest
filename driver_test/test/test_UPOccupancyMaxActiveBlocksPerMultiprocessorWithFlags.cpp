/*
 * Auto-generated smoke test for driver wrapper UPOccupancyMaxActiveBlocksPerMultiprocessorWithFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPOccupancyMaxActiveBlocksPerMultiprocessorWithFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPOccupancyMaxActiveBlocksPerMultiprocessorWithFlags(&local_numBlocks, kern, 0, (size_t)0, 0u);

    printf("UPOccupancyMaxActiveBlocksPerMultiprocessorWithFlags -> %d\n", (int)err);
    ...
    printf("test_UPOccupancyMaxActiveBlocksPerMultiprocessorWithFlags PASS\n");
    return 0;
}
