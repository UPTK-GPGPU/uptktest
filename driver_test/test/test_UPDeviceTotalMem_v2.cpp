/*
 * Auto-generated smoke test for driver wrapper UPDeviceTotalMem_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDeviceTotalMem_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDeviceTotalMem_v2(&local_bytes, dev);

    printf("UPDeviceTotalMem_v2 -> %d\n", (int)err);
    ...
    printf("test_UPDeviceTotalMem_v2 PASS\n");
    return 0;
}
