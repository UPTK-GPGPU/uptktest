/*
 * Auto-generated smoke test for driver wrapper UPDevicePrimaryCtxReset (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDevicePrimaryCtxReset setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDevicePrimaryCtxReset(dev);

    printf("UPDevicePrimaryCtxReset -> %d\n", (int)err);
    ...
    printf("test_UPDevicePrimaryCtxReset PASS\n");
    return 0;
}
