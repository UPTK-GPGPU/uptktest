/*
 * Auto-generated smoke test for driver wrapper UPSignalExternalSemaphoresAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_EXTERNAL_SEMAPHORE_SIGNAL_PARAMS local_paramsArray{};
    UPTKExternalSemaphore_t local_extSemArray{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPSignalExternalSemaphoresAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPSignalExternalSemaphoresAsync_ptsz(&local_extSemArray, &local_paramsArray, 0u, stream);

    printf("UPSignalExternalSemaphoresAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPSignalExternalSemaphoresAsync_ptsz PASS\n");
    return 0;
}
