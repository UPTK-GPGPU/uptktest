/*
 * Auto-generated smoke test for driver wrapper UPTexObjectGetTextureDesc (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexObjectGetTextureDesc setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexObjectGetTextureDesc(&local_pTexDesc, texObj);

    printf("UPTexObjectGetTextureDesc -> %d\n", (int)err);
    ...
    printf("test_UPTexObjectGetTextureDesc PASS\n");
    return 0;
}
