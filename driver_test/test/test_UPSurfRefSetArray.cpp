/*
 * Auto-generated smoke test for driver wrapper UPSurfRefSetArray (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPSurfRefSetArray setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPSurfRefSetArray(surfRef, arr, 0u);

    printf("UPSurfRefSetArray -> %d\n", (int)err);
    ...
    printf("test_UPSurfRefSetArray PASS\n");
    return 0;
}
