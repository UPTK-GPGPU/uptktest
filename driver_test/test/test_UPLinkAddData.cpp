/*
 * Auto-generated smoke test for driver wrapper UPLinkAddData (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLinkAddData setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPLinkAddData(linkState, (UPTKjitInputType)0, (void*)nullptr, (size_t)0, &local_name, 0u, &local_options, (void**)nullptr);

    printf("UPLinkAddData -> %d\n", (int)err);
    ...
    printf("test_UPLinkAddData PASS\n");
    return 0;
}
