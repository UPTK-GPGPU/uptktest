/*
 * Auto-generated smoke test for driver wrapper UPEventRecord (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPEventRecord setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPEventRecord(evt, stream);

    printf("UPEventRecord -> %d\n", (int)err);
    ...
    printf("test_UPEventRecord PASS\n");
    return 0;
}
