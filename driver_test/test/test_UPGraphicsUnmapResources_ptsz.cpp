/*
 * Auto-generated smoke test for driver wrapper UPGraphicsUnmapResources_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKGraphicsResource_t local_resources{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsUnmapResources_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsUnmapResources_ptsz(0u, &local_resources, stream);

    printf("UPGraphicsUnmapResources_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsUnmapResources_ptsz PASS\n");
    return 0;
}
