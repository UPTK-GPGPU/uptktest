/*
 * Auto-generated smoke test for driver wrapper UPCtxPopCurrent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxPopCurrent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxPopCurrent(&local_pctx);

    printf("UPCtxPopCurrent -> %d\n", (int)err);
    ...
    printf("test_UPCtxPopCurrent PASS\n");
    return 0;
}
