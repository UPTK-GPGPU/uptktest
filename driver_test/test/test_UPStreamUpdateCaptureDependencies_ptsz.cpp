/*
 * Auto-generated smoke test for driver wrapper UPStreamUpdateCaptureDependencies_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamUpdateCaptureDependencies_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamUpdateCaptureDependencies_ptsz(stream, &local_dependencies, (size_t)0, 0u);

    printf("UPStreamUpdateCaptureDependencies_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamUpdateCaptureDependencies_ptsz PASS\n");
    return 0;
}
