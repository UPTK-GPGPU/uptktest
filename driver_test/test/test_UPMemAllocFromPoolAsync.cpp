/*
 * Auto-generated smoke test for driver wrapper UPMemAllocFromPoolAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAllocFromPoolAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAllocFromPoolAsync(&local_dptr, (size_t)0, memPool, stream);

    printf("UPMemAllocFromPoolAsync -> %d\n", (int)err);
    ...
    printf("test_UPMemAllocFromPoolAsync PASS\n");
    return 0;
}
