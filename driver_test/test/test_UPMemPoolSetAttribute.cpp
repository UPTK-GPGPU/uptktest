/*
 * Auto-generated smoke test for driver wrapper UPMemPoolSetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemPoolSetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPMemPoolSetAttribute PASS\n");
    return 0;
}
