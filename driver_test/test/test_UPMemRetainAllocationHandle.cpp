/*
 * Auto-generated smoke test for driver wrapper UPMemRetainAllocationHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemRetainAllocationHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemRetainAllocationHandle(&local_handle, (void*)nullptr);

    printf("UPMemRetainAllocationHandle -> %d\n", (int)err);
    ...
    printf("test_UPMemRetainAllocationHandle PASS\n");
    return 0;
}
