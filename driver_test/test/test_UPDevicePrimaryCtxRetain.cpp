/*
 * Auto-generated smoke test for driver wrapper UPDevicePrimaryCtxRetain (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDevicePrimaryCtxRetain setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDevicePrimaryCtxRetain(&local_pctx, dev);

    printf("UPDevicePrimaryCtxRetain -> %d\n", (int)err);
    ...
    printf("test_UPDevicePrimaryCtxRetain PASS\n");
    return 0;
}
