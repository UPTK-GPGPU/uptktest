/*
 * Auto-generated smoke test for driver wrapper UPOccupancyMaxPotentialBlockSizeWithFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPOccupancyMaxPotentialBlockSizeWithFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPOccupancyMaxPotentialBlockSizeWithFlags(&local_minGridSize, &local_blockSize, kern, (UPTKoccupancyB2DSize)nullptr, (size_t)0, 0, 0u);

    printf("UPOccupancyMaxPotentialBlockSizeWithFlags -> %d\n", (int)err);
    ...
    printf("test_UPOccupancyMaxPotentialBlockSizeWithFlags PASS\n");
    return 0;
}
