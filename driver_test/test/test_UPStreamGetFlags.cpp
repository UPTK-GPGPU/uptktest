/*
 * Auto-generated smoke test for driver wrapper UPStreamGetFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetFlags(stream, &local_flags);

    printf("UPStreamGetFlags -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetFlags PASS\n");
    return 0;
}
