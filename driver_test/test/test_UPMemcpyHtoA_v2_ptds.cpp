/*
 * Auto-generated smoke test for driver wrapper UPMemcpyHtoA_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyHtoA_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyHtoA_v2_ptds(arr, (size_t)0, (const void*)nullptr, (size_t)0);

    printf("UPMemcpyHtoA_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyHtoA_v2_ptds PASS\n");
    return 0;
}
