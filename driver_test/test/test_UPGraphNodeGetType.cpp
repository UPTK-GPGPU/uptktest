/*
 * Auto-generated smoke test for driver wrapper UPGraphNodeGetType (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphNodeGetType setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphNodeGetType(graphNode, &local_type);

    printf("UPGraphNodeGetType -> %d\n", (int)err);
    ...
    printf("test_UPGraphNodeGetType PASS\n");
    return 0;
}
