/*
 * Auto-generated smoke test for driver wrapper UPModuleUnload (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleUnload setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPModuleUnload PASS\n");
    return 0;
}
