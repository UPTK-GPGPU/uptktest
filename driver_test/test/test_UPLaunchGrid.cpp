/*
 * Auto-generated smoke test for driver wrapper UPLaunchGrid (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchGrid setup failed (%d)\n", (int)err);
        return 0;
    }
