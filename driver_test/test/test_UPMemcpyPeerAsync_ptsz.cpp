/*
 * Auto-generated smoke test for driver wrapper UPMemcpyPeerAsync_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyPeerAsync_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyPeerAsync_ptsz(dptr, ctx, dptr, ctx, (size_t)0, stream);

    printf("UPMemcpyPeerAsync_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyPeerAsync_ptsz PASS\n");
    return 0;
}
