/*
 * Auto-generated smoke test for driver wrapper UPGetErrorName (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGetErrorName setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGetErrorName((UPTKError)0, &local_pStr);

    printf("UPGetErrorName -> %d\n", (int)err);
    ...
    printf("test_UPGetErrorName PASS\n");
    return 0;
}
