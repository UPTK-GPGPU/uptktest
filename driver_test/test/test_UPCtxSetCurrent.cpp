/*
 * Auto-generated smoke test for driver wrapper UPCtxSetCurrent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxSetCurrent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxSetCurrent(ctx);

    printf("UPCtxSetCurrent -> %d\n", (int)err);
    ...
    printf("test_UPCtxSetCurrent PASS\n");
    return 0;
}
