/*
 * Auto-generated smoke test for driver wrapper UPMemAddressFree (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemAddressFree setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemAddressFree(dptr, (size_t)0);

    printf("UPMemAddressFree -> %d\n", (int)err);
    ...
    printf("test_UPMemAddressFree PASS\n");
    return 0;
}
