/*
 * Auto-generated smoke test for driver wrapper UPMemsetD2D16Async (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemsetD2D16Async setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemsetD2D16Async(dptr, (size_t)0, (unsigned short)0, (size_t)0, (size_t)0, stream);

    printf("UPMemsetD2D16Async -> %d\n", (int)err);
    ...
    printf("test_UPMemsetD2D16Async PASS\n");
    return 0;
}
