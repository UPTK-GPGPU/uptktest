/*
 * Auto-generated smoke test for driver wrapper UPGraphKernelNodeGetAttribute (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKKernelNodeAttrValue local_value_out{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphKernelNodeGetAttribute setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphKernelNodeGetAttribute(graphNode, (UPTKKernelNodeAttrID)0, &local_value_out);

    printf("UPGraphKernelNodeGetAttribute -> %d\n", (int)err);
    ...
    printf("test_UPGraphKernelNodeGetAttribute PASS\n");
    return 0;
}
