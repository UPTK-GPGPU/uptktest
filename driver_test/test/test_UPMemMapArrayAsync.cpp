/*
 * Auto-generated smoke test for driver wrapper UPMemMapArrayAsync (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemMapArrayAsync setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemMapArrayAsync(&local_mapInfoList, 0u, stream);

    printf("UPMemMapArrayAsync -> %d\n", (int)err);
    ...
    printf("test_UPMemMapArrayAsync PASS\n");
    return 0;
}
