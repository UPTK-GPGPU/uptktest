/*
 * Auto-generated smoke test for driver wrapper UPMemcpyAtoH_v2_ptds (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemcpyAtoH_v2_ptds setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemcpyAtoH_v2_ptds((void*)nullptr, arr, (size_t)0, (size_t)0);

    printf("UPMemcpyAtoH_v2_ptds -> %d\n", (int)err);
    ...
    printf("test_UPMemcpyAtoH_v2_ptds PASS\n");
    return 0;
}
