/*
 * Auto-generated smoke test for driver wrapper UPGraphDestroyNode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphDestroyNode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphDestroyNode(graphNode);

    printf("UPGraphDestroyNode -> %d\n", (int)err);
    ...
    printf("test_UPGraphDestroyNode PASS\n");
    return 0;
}
