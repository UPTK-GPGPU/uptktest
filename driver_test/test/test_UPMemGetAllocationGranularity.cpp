/*
 * Auto-generated smoke test for driver wrapper UPMemGetAllocationGranularity (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    size_t local_granularity{};
    UPTKmemAllocationProp local_prop{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemGetAllocationGranularity setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemGetAllocationGranularity(&local_granularity, &local_prop, (UPTKmemAllocationGranularity_flags)0);

    printf("UPMemGetAllocationGranularity -> %d\n", (int)err);
    ...
    printf("test_UPMemGetAllocationGranularity PASS\n");
    return 0;
}
