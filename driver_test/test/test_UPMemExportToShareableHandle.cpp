/*
 * Auto-generated smoke test for driver wrapper UPMemExportToShareableHandle (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMemExportToShareableHandle setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMemExportToShareableHandle((void*)nullptr, (UPTKmemGenericAllocationHandle)0, (UPTKMemAllocationHandleType)0, 0ull);

    printf("UPMemExportToShareableHandle -> %d\n", (int)err);
    ...
    printf("test_UPMemExportToShareableHandle PASS\n");
    return 0;
}
