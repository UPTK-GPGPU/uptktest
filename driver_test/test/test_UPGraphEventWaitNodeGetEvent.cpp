/*
 * Auto-generated smoke test for driver wrapper UPGraphEventWaitNodeGetEvent (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphEventWaitNodeGetEvent setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphEventWaitNodeGetEvent(graphNode, &local_event_out);

    printf("UPGraphEventWaitNodeGetEvent -> %d\n", (int)err);
    ...
    printf("test_UPGraphEventWaitNodeGetEvent PASS\n");
    return 0;
}
