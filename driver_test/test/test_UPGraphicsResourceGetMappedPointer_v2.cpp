/*
 * Auto-generated smoke test for driver wrapper UPGraphicsResourceGetMappedPointer_v2 (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGraphicsResourceGetMappedPointer_v2 setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGraphicsResourceGetMappedPointer_v2(&local_pDevPtr, &local_pSize, gfxRes);

    printf("UPGraphicsResourceGetMappedPointer_v2 -> %d\n", (int)err);
    ...
    printf("test_UPGraphicsResourceGetMappedPointer_v2 PASS\n");
    return 0;
}
