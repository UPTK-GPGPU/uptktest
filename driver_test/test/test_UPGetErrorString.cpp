/*
 * Auto-generated smoke test for driver wrapper UPGetErrorString (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPGetErrorString setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPGetErrorString((UPTKError)0, &local_pStr);

    printf("UPGetErrorString -> %d\n", (int)err);
    ...
    printf("test_UPGetErrorString PASS\n");
    return 0;
}
