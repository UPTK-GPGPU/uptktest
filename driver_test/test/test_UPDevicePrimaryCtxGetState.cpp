/*
 * Auto-generated smoke test for driver wrapper UPDevicePrimaryCtxGetState (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDevicePrimaryCtxGetState setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDevicePrimaryCtxGetState(dev, &local_flags, &local_active);

    printf("UPDevicePrimaryCtxGetState -> %d\n", (int)err);
    ...
    printf("test_UPDevicePrimaryCtxGetState PASS\n");
    return 0;
}
