/*
 * Auto-generated smoke test for driver wrapper UPStreamWriteValue64_v2_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamWriteValue64_v2_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamWriteValue64_v2_ptsz(stream, dptr, (cuuint64_t)0, 0u);

    printf("UPStreamWriteValue64_v2_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamWriteValue64_v2_ptsz PASS\n");
    return 0;
}
