/*
 * Auto-generated smoke test for driver wrapper UPStreamGetFlags_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamGetFlags_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamGetFlags_ptsz(stream, &local_flags);

    printf("UPStreamGetFlags_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamGetFlags_ptsz PASS\n");
    return 0;
}
