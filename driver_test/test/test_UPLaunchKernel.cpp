/*
 * Auto-generated smoke test for driver wrapper UPLaunchKernel (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPLaunchKernel setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("test_UPLaunchKernel PASS\n");
    return 0;
}
