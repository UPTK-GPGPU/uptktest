/*
 * Auto-generated smoke test for driver wrapper UPStreamCopyAttributes_ptsz (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPStreamCopyAttributes_ptsz setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPStreamCopyAttributes_ptsz(stream, stream);

    printf("UPStreamCopyAttributes_ptsz -> %d\n", (int)err);
    ...
    printf("test_UPStreamCopyAttributes_ptsz PASS\n");
    return 0;
}
