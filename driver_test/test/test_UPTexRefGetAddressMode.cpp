/*
 * Auto-generated smoke test for driver wrapper UPTexRefGetAddressMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefGetAddressMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefGetAddressMode(&local_pam, texRef, 0);

    printf("UPTexRefGetAddressMode -> %d\n", (int)err);
    ...
    printf("test_UPTexRefGetAddressMode PASS\n");
    return 0;
}
