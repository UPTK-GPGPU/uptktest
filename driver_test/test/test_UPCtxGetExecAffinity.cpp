/*
 * Auto-generated smoke test for driver wrapper UPCtxGetExecAffinity (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTKexecAffinityParam local_pExecAffinity{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPCtxGetExecAffinity setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPCtxGetExecAffinity(&local_pExecAffinity, (UPTKexecAffinityType)0);

    printf("UPCtxGetExecAffinity -> %d\n", (int)err);
    ...
    printf("test_UPCtxGetExecAffinity PASS\n");
    return 0;
}
