/*
 * Auto-generated smoke test for driver wrapper UPModuleGetSurfRef (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPModuleGetSurfRef setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPModuleGetSurfRef(&local_pSurfRef, mod, &local_name);

    printf("UPModuleGetSurfRef -> %d\n", (int)err);
    ...
    printf("test_UPModuleGetSurfRef PASS\n");
    return 0;
}
