/*
 * Auto-generated smoke test for driver wrapper UPTexRefSetFilterMode (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPTexRefSetFilterMode setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPTexRefSetFilterMode(texRef, (UPTKfilter_mode)0);

    printf("UPTexRefSetFilterMode -> %d\n", (int)err);
    ...
    printf("test_UPTexRefSetFilterMode PASS\n");
    return 0;
}
