/*
 * Auto-generated smoke test for driver wrapper UPMipmappedArrayGetSparseProperties (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    UPTK_ARRAY_SPARSE_PROPERTIES local_sparseProperties{};
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPMipmappedArrayGetSparseProperties setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPMipmappedArrayGetSparseProperties(&local_sparseProperties, mipmap);

    printf("UPMipmappedArrayGetSparseProperties -> %d\n", (int)err);
    ...
    printf("test_UPMipmappedArrayGetSparseProperties PASS\n");
    return 0;
}
