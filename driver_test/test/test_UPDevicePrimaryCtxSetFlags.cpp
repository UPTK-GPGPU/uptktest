/*
 * Auto-generated smoke test for driver wrapper UPDevicePrimaryCtxSetFlags (driver_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSuccess) {
        printf("test_skip: UPDevicePrimaryCtxSetFlags setup failed (%d)\n", (int)err);
        return 0;
    }

    err = UPDevicePrimaryCtxSetFlags(dev, 0u);

    printf("UPDevicePrimaryCtxSetFlags -> %d\n", (int)err);
    ...
    printf("test_UPDevicePrimaryCtxSetFlags PASS\n");
    return 0;
}
