...
int main() {
    ...
    double ha=1.0;
    CHECK_CUBLAS(UPTKblasXtDtrsm(handle,UPTKBLAS_SIDE_LEFT,UPTKBLAS_FILL_MODE_LOWER,UPTKBLAS_OP_N,UPTKBLAS_DIAG_NON_UNIT,m,n,&ha,hA,m,hB,m));
    CHECK_CUBLAS(UPTKblasXtDestroy(handle));
    printf("test_cublasXtDtrsm PASS\n");
    return 0;
}
