...
int main() {
    ...
    double hd1=1.0,hd2=1.0,hx1=3.0;
    const double hy1=4.0;
    double hp[5];
    CHECK_CUBLAS(UPTKblasDrotmg(handle,&hd1,&hd2,&hx1,&hy1,hp));
    printf("  drotmg: d1=%f d2=%f x1=%f\n",hd1,hd2,hx1);
    CHECK_CUBLAS(UPTKblasDestroy(handle));
    printf("test_cublasDrotmg_v2 PASS\n");
    return 0;
}
