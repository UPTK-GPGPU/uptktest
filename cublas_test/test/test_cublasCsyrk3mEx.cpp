...
int main() {
    ...
    CHECK_CUBLAS(UPTKblasCsyrk3mEx(handle,UPTKBLAS_FILL_MODE_LOWER,UPTKBLAS_OP_N,n,k,&ha,dA,UPTK_C_32F,n,&hb,dC,UPTK_C_32F,n));
    UPTKFree(dA);UPTKFree(dC);
    CHECK_CUBLAS(UPTKblasDestroy(handle));
    printf("test_cublasCsyrk3mEx PASS\n");
    return 0;
}
