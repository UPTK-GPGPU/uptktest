...
int main() {
    ...
    float ha=1.0f;
    CHECK_CUBLAS(UPTKblasXtStrmm(handle,UPTKBLAS_SIDE_LEFT,UPTKBLAS_FILL_MODE_LOWER,UPTKBLAS_OP_N,UPTKBLAS_DIAG_NON_UNIT,m,n,&ha,hA,m,hB,m,hC,m));
    CHECK_CUBLAS(UPTKblasXtDestroy(handle));
    printf("test_cublasXtStrmm PASS\n");
    return 0;
}
