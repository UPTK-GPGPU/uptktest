...
int main() {
    ...
    CHECK_CUBLAS(UPTKblasXtZtrsm(handle,UPTKBLAS_SIDE_LEFT,UPTKBLAS_FILL_MODE_LOWER,UPTKBLAS_OP_N,UPTKBLAS_DIAG_NON_UNIT,m,n,&ha,hA,m,hB,m));
    CHECK_CUBLAS(UPTKblasXtDestroy(handle));
    printf("test_cublasXtZtrsm PASS\n");
    return 0;
}
