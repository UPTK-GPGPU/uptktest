...
int main() {
    ...
    // Scenario 1: Set event on event record node
    {
        UPTKGraph_t graph;
    ...
    // Scenario 2: Set event and launch graph
    {
        ...
        CHECK_CUDA(UPTKGraphEventRecordNodeSetEvent(recordNode, event));
    ...
    printf("test_cudaGraphEventRecordNodeSetEvent PASS\n");
    return 0;
}
