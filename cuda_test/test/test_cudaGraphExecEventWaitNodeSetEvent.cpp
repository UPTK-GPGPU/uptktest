...
int main() {
    ...
    // Scenario 1: Set event on exec event wait node
    {
        UPTKGraph_t graph;
        ...
        CHECK_CUDA(UPTKEventRecord(event1, 0));
        ...
        CHECK_CUDA(UPTKGraphExecEventWaitNodeSetEvent(exec, waitNode, event2));
    ...
    // Scenario 2: Set same event and launch
    {
        ...
        CHECK_CUDA(UPTKGraphExecEventWaitNodeSetEvent(exec, waitNode, event));
    ...
    printf("test_cudaGraphExecEventWaitNodeSetEvent PASS\n");
    return 0;
}
