...
int main() {
    ...
    UPTKError_t err = UPTKGraphReleaseUserObject(NULL, (UPTKUserObject_t)0xDEADBEEF, 1);
    ...
    err = UPTKGraphReleaseUserObject(graph, NULL, 1);
    if (err != UPTKErrorInvalidValue) {
    ...
    err = UPTKGraphReleaseUserObject(graph, (UPTKUserObject_t)0xDEADBEEF, 0);
    if (err != UPTKErrorInvalidValue) {
    ...
    printf("test_cudaGraphReleaseUserObject PASS\n");
    return 0;
}
