...
int main() {
    ...
    UPTKError_t err = UPTKGraphMemcpyNodeSetParamsFromSymbol((UPTKGraphNode_t)0xDEADBEEF, h_data, (const void*)d_data, sizeof(h_data), 0, UPTKMemcpyDeviceToHost);
    ...
    initParams.srcPtr = make_UPTKPitchedPtr(d_data, sizeof(h_data), sizeof(h_data), 1);
    ...
    initParams.kind = UPTKMemcpyDeviceToHost;
    ...
    err = UPTKGraphMemcpyNodeSetParamsFromSymbol(memcpyNode, h_data, (const void*)d_data, sizeof(h_data), 0, UPTKMemcpyDeviceToHost);
    ...
    err = UPTKGraphMemcpyNodeSetParamsFromSymbol(memcpyNode, h_data, (const void*)d_data, 0, 0, UPTKMemcpyDeviceToHost);
    if (err != UPTKSuccess && err != UPTKErrorInvalidValue && err != UPTKErrorInvalidSymbol) {
    ...
    printf("test_cudaGraphMemcpyNodeSetParamsFromSymbol PASS\n");
    return 0;
}
