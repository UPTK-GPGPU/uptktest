/*
 * Auto-generated smoke test for UPTKsparseDpruneDense2csr_bufferSizeExt (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseDpruneDense2csr_bufferSizeExt setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("UPTKsparseDpruneDense2csr_bufferSizeExt -> %d\n", (int)err);
