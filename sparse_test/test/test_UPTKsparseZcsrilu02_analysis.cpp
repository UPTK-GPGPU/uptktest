/*
 * Auto-generated smoke test for UPTKsparseZcsrilu02_analysis (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseZcsrilu02_analysis setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("UPTKsparseZcsrilu02_analysis -> %d\n", (int)err);
