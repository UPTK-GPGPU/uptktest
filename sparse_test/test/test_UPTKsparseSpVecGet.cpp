...
int main(void)
{
    ...
    err = UPTKsparseSpVecGet(spVecDescr, (int64_t*)dev_scratch, (int64_t*)dev_scratch, (void**)nullptr, (void**)nullptr, (UPTKsparseIndexType_t*)dev_scratch, (UPTKsparseIndexBase_t*)dev_scratch, (UPTKDataType*)dev_scratch);
