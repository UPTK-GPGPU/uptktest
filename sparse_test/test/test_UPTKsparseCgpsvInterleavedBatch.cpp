/*
 * Auto-generated smoke test for UPTKsparseCgpsvInterleavedBatch (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseCgpsvInterleavedBatch setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseCgpsvInterleavedBatch(sparse_handle, 0, 0, (cuComplex*)dev_scratch, (cuComplex*)dev_scratch, (cuComplex*)dev_scratch, (cuComplex*)dev_scratch, (cuComplex*)dev_scratch, (cuComplex*)dev_scratch, 0, (void*)nullptr);

    printf("UPTKsparseCgpsvInterleavedBatch -> %d\n", (int)err);


    sparse_teardown_core(sparse_handle, dev_scratch, stream_id, 1);
    printf("test_UPTKsparseCgpsvInterleavedBatch PASS\n");
    return 0;
}
