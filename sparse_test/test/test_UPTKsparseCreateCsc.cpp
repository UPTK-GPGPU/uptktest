/*
 * Auto-generated smoke test for UPTKsparseCreateCsc (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseCreateCsc setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseCreateCsc(&spMatDescr, (int64_t)0, (int64_t)0, (int64_t)0, (void*)nullptr, (void*)nullptr, (void*)nullptr, (UPTKsparseIndexType_t)UPTKSPARSE_INDEX_32I, (UPTKsparseIndexType_t)UPTKSPARSE_INDEX_32I, (UPTKsparseIndexBase_t)UPTKSPARSE_INDEX_BASE_ZERO, (UPTKDataType_t)UPTK_R_32F);

    printf("UPTKsparseCreateCsc -> %d\n", (int)err);


    sparse_teardown_core(sparse_handle, dev_scratch, stream_id, 1);
    printf("test_UPTKsparseCreateCsc PASS\n");
    return 0;
}
