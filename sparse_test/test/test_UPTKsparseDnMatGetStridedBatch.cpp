/*
 * Auto-generated smoke test for UPTKsparseDnMatGetStridedBatch (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseDnMatGetStridedBatch setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseDnMatGetStridedBatch(dnMatDescr, (int*)dev_scratch, (int64_t*)dev_scratch);

    printf("UPTKsparseDnMatGetStridedBatch -> %d\n", (int)err);


    sparse_teardown_core(sparse_handle, dev_scratch, stream_id);
    printf("test_UPTKsparseDnMatGetStridedBatch PASS\n");
    return 0;
}
