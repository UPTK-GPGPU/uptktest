/*
 * Auto-generated smoke test for UPTKsparseZnnz_compress (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseZnnz_compress setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("UPTKsparseZnnz_compress -> %d\n", (int)err);
