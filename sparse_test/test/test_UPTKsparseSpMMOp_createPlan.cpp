/*
 * Auto-generated smoke test for UPTKsparseSpMMOp_createPlan (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseSpMMOp_createPlan setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseSpMMOp_createPlan(sparse_handle, (UPTKsparseSpMMOpPlan_t*)dev_scratch, (UPTKsparseOperation_t)UPTKSPARSE_OPERATION_NON_TRANSPOSE, (UPTKsparseOperation_t)UPTKSPARSE_OPERATION_NON_TRANSPOSE, matA, matB, matC, (UPTKDataType_t)UPTK_R_32F, (UPTKsparseSpMMOpAlg_t)0, (const void*)dev_scratch, (size_t)0, (const void*)dev_scratch, (size_t)0, (const void*)dev_scratch, (size_t)0, (size_t*)dev_scratch);

    printf("UPTKsparseSpMMOp_createPlan -> %d\n", (int)err);


    sparse_teardown_core(sparse_handle, dev_scratch, stream_id, 1);
    printf("test_UPTKsparseSpMMOp_createPlan PASS\n");
    return 0;
}
