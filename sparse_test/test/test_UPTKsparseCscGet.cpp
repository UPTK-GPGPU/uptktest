/*
 * Auto-generated smoke test for UPTKsparseCscGet (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseCscGet setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseCscGet(spMatDescr, (int64_t*)dev_scratch, (int64_t*)dev_scratch, (int64_t*)dev_scratch, (void**)nullptr, (void**)nullptr, (void**)nullptr, (UPTKsparseIndexType_t*)dev_scratch, (UPTKsparseIndexType_t*)dev_scratch, (UPTKsparseIndexBase_t*)dev_scratch, (UPTKDataType*)dev_scratch);

    printf("UPTKsparseCscGet -> %d\n", (int)err);


    sparse_teardown_core(sparse_handle, dev_scratch, stream_id, 1);
    printf("test_UPTKsparseCscGet PASS\n");
    return 0;
}
