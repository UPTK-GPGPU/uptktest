/*
 * Auto-generated smoke test for UPTKsparseCcsrcolor (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseCcsrcolor setup failed (%d)\n", (int)err);
        return 0;
    }
