/*
 * Auto-generated smoke test for UPTKsparseSpruneDense2csrNnzByPercentage (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseSpruneDense2csrNnzByPercentage setup failed (%d)\n", (int)err);
        return 0;
    }
    ...
    printf("UPTKsparseSpruneDense2csrNnzByPercentage -> %d\n", (int)err);
