/*
 * Auto-generated smoke test for UPTKsparseSpGEMMreuse_workEstimation (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseSpGEMMreuse_workEstimation setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseSpGEMMreuse_workEstimation(sparse_handle, (UPTKsparseOperation_t)UPTKSPARSE_OPERATION_NON_TRANSPOSE, (UPTKsparseOperation_t)UPTKSPARSE_OPERATION_NON_TRANSPOSE, matA, matB, matC, (UPTKsparseSpGEMMAlg_t)0, spgemmDescr, (size_t*)dev_scratch, (void*)nullptr);
