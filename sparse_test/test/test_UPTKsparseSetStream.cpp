/*
 * Auto-generated smoke test for UPTKsparseSetStream (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseSetStream setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseSetStream(sparse_handle, stream_id);
