/*
 * Auto-generated smoke test for UPTKsparseSbsrilu02_numericBoost (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseSbsrilu02_numericBoost setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseSbsrilu02_numericBoost(sparse_handle, (bsrilu02Info_t)0, 0, (double*)dev_scratch, (float*)dev_scratch);

    printf("UPTKsparseSbsrilu02_numericBoost -> %d\n", (int)err);


    sparse_teardown_core(sparse_handle, dev_scratch, stream_id);
    printf("test_UPTKsparseSbsrilu02_numericBoost PASS\n");
    return 0;
}
