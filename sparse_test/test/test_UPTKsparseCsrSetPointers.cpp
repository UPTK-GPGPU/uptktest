/*
 * Auto-generated smoke test for UPTKsparseCsrSetPointers (sparse_fun_convert.cpp).
...
int main(void)
{
    ...
    if (err != UPTKSPARSE_STATUS_SUCCESS) {
        printf("test_skip: UPTKsparseCsrSetPointers setup failed (%d)\n", (int)err);
        return 0;
    }


    err = UPTKsparseCsrSetPointers(spMatDescr, (void*)nullptr, (void*)nullptr, (void*)nullptr);

    printf("UPTKsparseCsrSetPointers -> %d\n", (int)err);


    sparse_teardown_core(sparse_handle, dev_scratch, stream_id);
    printf("test_UPTKsparseCsrSetPointers PASS\n");
    return 0;
}
