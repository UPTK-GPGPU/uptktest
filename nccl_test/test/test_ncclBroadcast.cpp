...
int main() {
    ...
    // 场景1: 基础 Broadcast with UPTKncclFloat32, root=0
    {
        float* sendbuff = NULL;
        float* recvbuff = NULL;
        ...
        CHECK_NCCL(UPTKncclBroadcast(sendbuff, recvbuff, count, UPTKncclFloat32, 0, comm, stream));
    ...
    // 场景2: Broadcast with UPTKncclInt32
    {
        int* sendbuff = NULL;
        int* recvbuff = NULL;
        ...
        CHECK_NCCL(UPTKncclBroadcast(sendbuff, recvbuff, count, UPTKncclInt32, 0, comm, stream));
        UPTKStreamSynchronize(stream);
    ...
    // 场景3: In-place Broadcast (sendbuff == recvbuff)
    {
        float* buff = NULL;
    ...
    printf("test_UPTKncclBroadcast PASS\n");
    return 0;
}
