/*
 * Auto-generated smoke test for UPTKrandGetDirectionVectors32 (rand_fun_convert.cpp).
...
int main(void)
{
    ...
    void *dev_scratch{};
    UPTKStream_t stream_id{};
    UPTKrandDirectionVectors32_t *dv32_holder{};
    ...
    printf("test_UPTKrandGetDirectionVectors32 PASS\n");
    return 0;
}
