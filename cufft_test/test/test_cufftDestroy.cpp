...
int main() {
    ...
    // Scene 1: Basic create and destroy
    UPTKfftHandle plan;
    CHECK_CUFFT(UPTKfftCreate(&plan));
    CHECK_CUFFT(UPTKfftDestroy(plan));

    // Scene 2: Create, make plan, then destroy
    UPTKfftHandle plan2;
