...
TEST(cufft, 3d_c2c_example)
{
    ...
    expect_data[1] = data_type(8.f, -8.f);
    expect_data[2] = data_type(16.f, -16.f);
    expect_data[3] = data_type(24.f, -24.f);
    expect_data[4] = data_type(32.f, -32.f);
    expect_data[5] = data_type(40.f, -40.f);
    expect_data[6] = data_type(48.f, -48.f);
    expect_data[7] = data_type(56.f, -56.f);
    expect_data[8] = data_type(64.f, -64.f);
    expect_data[9] = data_type(72.f, -72.f);
    expect_data[10] = data_type(80.f, -80.f);
    expect_data[11] = data_type(88.f, -88.f);
    expect_data[12] = data_type(96.f, -96.f);
    expect_data[13] = data_type(104.f, -104.f);
    expect_data[14] = data_type(112.f, -112.f);
    expect_data[15] = data_type(120.f, -120.f);
