...
void z2z_2d_inplace()
{
  ...
  UPTKfftPlan2d(&plan_fwd, 2, 5, UPTKFFT_Z2Z);
  ...
  UPTKfftPlan2d(&plan_bwd, 2, 5, UPTKFFT_Z2Z);
...
TEST(cufft_runable, z2z_2d_inplace)
{
#define FUNC z2z_2d_inplace
  FUNC();
  UPTKDeviceSynchronize();
}
