...
void c2c_3d_outofplace()
{
  ...
  UPTKfftPlan3d(&plan_fwd, 2, 3, 5, UPTKFFT_C2C);
  ...
  UPTKfftPlan3d(&plan_bwd, 2, 3, 5, UPTKFFT_C2C);
...
TEST(cufft_runable, c2c_3d_outofplace)
{
#define FUNC c2c_3d_outofplace
  FUNC();
  UPTKDeviceSynchronize();
}
