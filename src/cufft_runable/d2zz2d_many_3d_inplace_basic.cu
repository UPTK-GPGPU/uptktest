...
void d2zz2d_many_3d_inplace_basic()
{
  ...
  int n[3] = {4, 2, 3};
  size_t workSize;
  cufftMakePlanMany(plan_fwd, 3, n, nullptr, 0, 0, nullptr, 0, 0, CUFFT_D2Z, 2, &workSize);
  ...
  cufftMakePlanMany(plan_bwd, 3, n, nullptr, 0, 0, nullptr, 0, 0, CUFFT_Z2D, 2, &workSize);
