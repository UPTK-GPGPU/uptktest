...
void c2c_2d_inplace()
{
  ...
  UPTKfftPlan2d(&plan_fwd, 2, 5, UPTKFFT_C2C);
  ...
  UPTKfftPlan2d(&plan_bwd, 2, 5, UPTKFFT_C2C);
...
TEST(cufft_runable, c2c_2d_inplace)
{
#define FUNC c2c_2d_inplace
  FUNC();
  UPTKDeviceSynchronize();
}
