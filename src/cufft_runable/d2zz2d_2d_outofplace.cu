...
void d2zz2d_2d_outofplace()
{
  ...
  UPTKfftPlan2d(&plan_fwd, 4, 5, UPTKFFT_D2Z);
  ...
  UPTKfftPlan2d(&plan_bwd, 4, 5, UPTKFFT_Z2D);
...
TEST(cufft_runable, d2zz2d_2d_outofplace)
{
