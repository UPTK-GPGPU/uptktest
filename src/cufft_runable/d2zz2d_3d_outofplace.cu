...
void d2zz2d_3d_outofplace()
{
  ...
  cufftPlan3d(&plan_fwd, 2, 3, 5, CUFFT_D2Z);
  ...
  cufftPlan3d(&plan_bwd, 2, 3, 5, CUFFT_Z2D);
...
TEST(cufft_runable, d2zz2d_3d_outofplace)
{
