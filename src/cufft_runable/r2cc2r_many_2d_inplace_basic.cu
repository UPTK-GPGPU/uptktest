...
void r2cc2r_many_2d_inplace_basic()
{
  ...
  int n[2] = {2, 3};
  size_t workSize;
  cufftMakePlanMany(plan_fwd, 2, n, nullptr, 0, 0, nullptr, 0, 0, CUFFT_R2C, 2, &workSize);
  ...
  cufftMakePlanMany(plan_bwd, 2, n, nullptr, 0, 0, nullptr, 0, 0, CUFFT_C2R, 2, &workSize);
