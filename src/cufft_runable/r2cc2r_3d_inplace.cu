...
void r2cc2r_3d_inplace()
{
  ...
  cufftPlan3d(&plan_fwd, 2, 3, 5, CUFFT_R2C);
  ...
  cufftPlan3d(&plan_bwd, 2, 3, 5, CUFFT_C2R);
...
TEST(cufft_runable, r2cc2r_3d_inplace)
{
#define FUNC r2cc2r_3d_inplace
  FUNC();
  cudaDeviceSynchronize();
}
