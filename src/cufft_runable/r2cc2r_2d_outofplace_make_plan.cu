// ===--- r2cc2r_2d_outofplace_make_plan.cu ------------------*- CUDA -*---===//
//
...
void r2cc2r_2d_outofplace_make_plan()
{
  ...
  size_t workSize;
  UPTKfftMakePlan2d(plan_fwd, 4, 5, UPTKFFT_R2C, &workSize);
  ...
  UPTKfftMakePlan2d(plan_bwd, 4, 5, UPTKFFT_C2R, &workSize);
...
TEST(cufft_runable, r2cc2r_2d_outofplace_make_plan)
{
#define FUNC r2cc2r_2d_outofplace_make_plan
  FUNC();
  UPTKDeviceSynchronize();
}
