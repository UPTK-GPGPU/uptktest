...
#define HIP_CHECK(condition) ASSERT_EQ(condition, cudaSuccess)
...
template <class InputType, class ExecutionPolicy = std::decay_t<decltype(thrust::cuda::par)>>
struct Params
{
...
typedef ::testing::Types<Params<thrust::host_vector<short>>,
                         ...
                         Params<thrust::device_vector<int>, std::decay_t<decltype(thrust::cuda::par_nosync)>>,
