...
TEST(cusparse, spvv_example) {
    ...
    CHECK_CUSPARSE( cusparseSpVV_bufferSize(handle,
                                            ...
                                            vecX, vecY, &tmp_result, CUDA_R_32F,
                                            &bufferSize) )
    ...
    //--------------------------------------------------------------------------
    // device result check
    EXPECT_FLOAT_EQ(tmp_result, result);
    // if (tmp_result == result)
    //     printf("spvv_example test PASSED\n");
    // else
    //     printf("spvv_example test FAILED: wrong result\n");
    //--------------------------------------------------------------------------
