...
TEST(cublas_level_3,cublas_syrkx_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasDsyrkx(cublasH, uplo, transa, n, k, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {26.0,0.0,31.0,53.0};
    //printf("C\n");
