...
TEST(cublas_level_3,cublas_hemm_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasZhemm(cublasH, side, uplo, m, n, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{-17.38, 18.62},{4.82, 38.90},{-23.14, 26.78},{10.58, 55.70}};
    //printf("C\n");
