...
TEST(cublas_level_3,cublas_herkx_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasZherkx(cublasH, uplo, transa, n, k, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{13.70, 0.00},{0.00, 0.00},{30.02, 30.98},{70.34, 0.00}};
    //printf("C\n");
