...
TEST(cublas_level_3,cublas_herk_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasZherk(cublasH, uplo, transa, n, k, &alpha, d_A, lda, &beta, d_C, ldc));
    ...
    /*
     *   C = | 13.70 + 0.00j | 30.50 + 0.48j |
     *       |  0.00 + 0.00j | 70.34 + 0.00j |
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{13.70, 0.00},{0.00, 0.00},{30.50, 0.48},{70.34, 0.00}};
    //printf("C\n");
