...
TEST(cublas_level_3,cublas_syrk_example) {
    ...
    UPTKblasOperation_t transa = UPTKBLAS_OP_T;
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDsyrk(cublasH, uplo, transa, n, k, &alpha, d_A, lda, &beta, d_C, ldc));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {10.0,0.0,15.0,25.0};
    //printf("C\n");
