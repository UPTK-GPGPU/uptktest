...
TEST(cublas_level_3,cublas_trmm_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasDtrmm(cublasH, side, uplo, transa, diag, m, n, &alpha, d_A, lda, d_B, ldb, d_C, ldc));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {19.0,28.0,22.0,32.0};
    //printf("C\n");
