...
TEST(cublas_level_3,cublas_her2k_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasZher2k(cublasH, uplo, transa, n, k, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
    ...
    /*
     *   C = | 27.40 + 0.00j |  61.00 + 0.96j |
     *       |  0.00 + 0.00j | 140.68 + 0.00j |
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{27.40, 0.00},{0.00, 0.00},{61.00, 0.96},{140.68, 0.00}};
    //printf("C\n");
