...
TEST(cublas_level_3,cublas_gemm_example){
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasDgemm(cublasH, transa, transb, m, n, k, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {23.0,34.0,31.0,46.0};
    //printf("C\n");
