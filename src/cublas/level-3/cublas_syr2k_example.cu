...
TEST(cublas_level_3,cublas_syr2k_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasDsyr2k(cublasH, uplo, transa, n, k, &alpha, d_A, lda, d_B, ldb, &beta, d_C, ldc));
    ...
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {52.0,0.0,74.0,106.0};
    //printf("C\n");
