...
TEST(cublas_level_2,cublas_hpr_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasZhpr(cublasH, uplo, n, &alpha, d_x, incx, d_AP));
    ...
    /*
     *   AP = | 65.55 + 0.00j | 126.15 + 0.00j |
     *        | 92.81 + 6.02j |   4.70 + 4.80j |
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{65.55, 0.00}, {92.81, 6.02},{126.15, 0.00}, {4.70, 4.80}};
    //printf("AP\n");
