...
TEST(cublas_level_2,cublas_spr2_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDger(cublasH, uplo, n, &alpha, d_x, incx, d_y, incy, d_AP, lda));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {36.0,3.0,43.0,4.0};
    //printf("AP\n");
