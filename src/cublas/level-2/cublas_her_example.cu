...
TEST(cublas_level_2,cublas_her_example){
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasZher(cublasH, uplo, n, &alpha, d_x, incx, d_A, lda));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{65.55, 0.00}, {3.50, 3.60}, {91.61, 4.82}, {128.55, 0.00}};
    //printf("A\n");
