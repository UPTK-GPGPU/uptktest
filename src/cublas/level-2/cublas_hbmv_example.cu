...
TEST(cublas_level_2,cublas_hbmv_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasZhbmv(cublasH, uplo, n, k, &alpha, d_A, lda, d_x, incx, &beta, d_y, incy));
    ...
    /*
     *   y = | -44.06 + 73.02j 19.42 + 102.42j |
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{-44.06, 73.02}, {19.42,102.42}};
    //printf("y\n");
