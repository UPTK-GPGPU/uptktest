...
TEST(cublas_level_2,cublas_spr_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDspr(cublasH, uplo, n, &alpha, d_x, incx, d_AP));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {26.0,33.0,39.0,4.0};
    //printf("AP\n");
