...
TEST(cublas_level_2,cublas_ger_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDger(cublasH, m, n, &alpha, d_x, incx, d_y, incy, d_A, lda));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {71.0, 87.0, 82.0, 100.0};
    //printf("A\n");
