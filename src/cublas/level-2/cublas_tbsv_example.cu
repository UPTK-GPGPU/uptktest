...
TEST(cublas_level_2,cublas_tbsv_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDtbsv(cublasH, uplo, transa, diag, n, k, d_A, lda, d_x, incx));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {0.67, 1.50};
    //printf("x\n");
