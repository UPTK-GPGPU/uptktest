...
TEST(cublas_level_2,cublas_gemv_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasDgemv(cublasH, transa, m, n, &alpha, d_A, lda, d_x, incx, &beta, d_y, incy));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {17.00, 39.00};
    //printf("y\n");
