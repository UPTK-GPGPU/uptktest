...
TEST(cublas_level_2,cublas_tpmv_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDtpmv(cublasH, uplo, transa, diag, n, d_AP, d_x, incx));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {23.00, 12.00};
    //printf("x\n");
