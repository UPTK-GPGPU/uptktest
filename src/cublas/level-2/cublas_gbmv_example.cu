...
TEST(cublas_level_2,cublas_gbmv_example){
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasDgbmv(cublasH, transa, m, n, kl, ku, &alpha, d_A, lda, d_x, incx, &beta, d_y, incy));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {27.0, 24.0};
    //printf("y\n");
