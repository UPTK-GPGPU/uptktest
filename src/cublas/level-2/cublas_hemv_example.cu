...
TEST(cublas_level_2,cublas_hemv_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasZhemv(cublasH, uplo, n, &alpha, d_A, lda, d_x, incx, &beta, d_y, incy));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{-41.42, 45.90}, {19.42,102.42}};
    //printf("y\n");
