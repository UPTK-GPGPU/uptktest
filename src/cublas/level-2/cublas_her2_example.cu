...
TEST(cublas_level_2,cublas_her2_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasZher2(cublasH, uplo, n, &alpha, d_x, incx, d_y, incy, d_A, lda));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {{48.40, 0.00}, {3.50, 3.60}, {81.72, 24.84}, {135.60, 0.00}};
    //printf("A\n");
