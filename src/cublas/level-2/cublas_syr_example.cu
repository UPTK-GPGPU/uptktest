...
TEST(cublas_level_2,cublas_syr_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDsyr(cublasH, uplo, n, &alpha, d_x, incx, d_A, lda));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {26.0,3.0,33.0,40.0};
    //printf("A\n");
