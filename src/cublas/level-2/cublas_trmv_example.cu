...
TEST(cublas_level_2,cublas_trmv_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDtrmv(cublasH, uplo, transa, diag, n, d_A, lda, d_x, incx));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {17.00, 24.00};
    //printf("x\n");
