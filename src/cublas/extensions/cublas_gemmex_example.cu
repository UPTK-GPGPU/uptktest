...
TEST(cublas_extensions,cublas_gemmex_example) {
    ...
    CUBLAS_CHECK(UPTKblasGemmEx(
        ...
        UPTK_R_64F, UPTKBLAS_GEMM_DEFAULT));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {19.0,43.0,22.0,50.0};
    //printf("C\n");
