...
TEST(cublas_extensions,cublas_dotex_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDotEx(cublasH, A.size(), d_A, traits<data_type>::cuda_data_type, incx, d_B,
     ...
     *   result = 70.00
     */
    EXPECT_EQ(result, 70.00);

    // double eps = 1.0E-2;
    // const std::vector<data_type> expect = {70.00};
