...
TEST(cublas_extensions,cublas_rotex_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasRotEx(cublasH, A.size(), d_A, traits<data_type>::cuda_data_type, incx, d_B,
                             traits<data_type>::cuda_data_type, incy, &c, &s,
    ...
    /*
     *   A = | 8.1 11.4 14.7 18.0 |
     *   B = | 9.3 10.2 11.1 12.0 |
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect1 = {8.1, 11.4, 14.7, 18.0};
    const std::vector<data_type> expect2 = {9.3, 10.2, 11.1, 12.0};
