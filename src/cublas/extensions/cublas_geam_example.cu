...
TEST(cublas_extensions,cublas_geam_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(
        UPTKblasDgeam(cublasH, transa, transb, m, n, &alpha, d_A, lda, &beta, d_B, ldb, d_C, ldc));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect = {11.0,17.0,14.0,20.0};
    //printf("C\n");
