...
TEST(cublas_level_1,cublas_amin_example){
    ...
    const std::vector<data_type> A = {11.0, 2.0, 3.0, 4.0};
    const int incx = 1;
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasIdamin(cublasH, A.size(), d_A, incx, &result));
    ...
    // printf("=====\n");
    //double eps = 1.0E-2;
    //const std::vector<data_type> expect = {1};
    //printf("A (scaled)\n");
