...
TEST(cublas_level_1,cublas_swap_example) {
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDswap(cublasH, A.size(), d_A, incx, d_B, incy));
     ...
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect1 = {5.0, 6.0, 7.0, 8.0};
    const std::vector<data_type> expect2 = {1.0, 2.0, 3.0, 4.0};
