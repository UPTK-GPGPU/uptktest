...
TEST(cublas_level_1,cublas_rotm_example){
    ...
    /* step 3: compute */
    CUBLAS_CHECK(UPTKblasDrotm(cublasH, A.size(), d_A, incx, d_B, incy, param.data()));
    ...
    /*
     *   A = | 10.0 16.0 22.0 28.0 |
     *   B = | 39.0 46.0 53.0 60.0 |
     */
    double eps = 1.0E-2;
    const std::vector<data_type> expect1 = {10.0, 16.0, 22.0, 28.0};
    const std::vector<data_type> expect2 = {39.0, 46.0, 53.0, 60.0};
