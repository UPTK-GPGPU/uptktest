...
TEST(cusolver, cusolver_sygvd_example) {
    ...
    double eps = 1.0E-2;
    std::vector<double> expect={0.050,0.09,0.23,0.30,-0.16,-0.02,-0.12,-0.31,0.28};
    //std::printf("V = (matlab base-1)\n");
    check_matrix(m, m, V.data(), lda,expect.data(),eps);
    //std::printf("=====\n");
