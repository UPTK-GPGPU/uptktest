...
TEST(cusolver, cusolver_getrf_example) {
    ...
    //     printf("compute P*A = L*U \n");
    

    // printf("A = (matlab base-1)\n");
    // check_matrix(m, m, A.data(), lda);
    // printf("=====\n");

    // printf("B = (matlab base-1)\n");
    // check_matrix(m, 1, B.data(), ldb);
    // printf("=====\n");
    ...
    std::vector<double> expect1={7.0,0.14,0.57,8.0,0.86,0.50,10,1.57,-0.50};
    //printf("L and U = (matlab base-1)\n");
    check_matrix(m, m, LU.data(), lda, expect1.data(), eps);
    //printf("=====\n");
    ...
    CUDA_CHECK(cudaStreamSynchronize(stream));
    std::vector<double> expect2={-0.33,0.67,0.0};

    //printf("X = (matlab base-1)\n");
    check_matrix(m, 1, X.data(), ldb,expect2.data(),eps);
    //printf("=====\n");
